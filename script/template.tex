...
{\contentslabel{1.5em}}{}{\titlerule*[0.3pc]{.}\contentspage}
            ...
            if sections then
                for j, section in ipairs(sections) do
                    ...
                    if file_path and file_path ~= "" then
                        ...
                        local options = "pages=-, width=\\textwidth, height=\\textheight, keepaspectratio, " ..
...
\begin{titlepage}
    ...
    \vspace{1cm}
    {\Large \itshape \color{gray} \makeatletter 基于 \@date 构建 \makeatother \par}
...
\begin{center}
    ...
    \vspace{1cm}
    {\small Generated by GitHub Actions & LuaLaTeX}
\end{center}
\vspace*{\fill}
