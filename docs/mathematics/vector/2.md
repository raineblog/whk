...
\[
\vec{n} = +\begin{vmatrix}y_1 & z_1 \\ y_2 & z_2\end{vmatrix} \cdot \mathbf{i} \quad -\begin{vmatrix}x_1 & z_1 \\ x_2 & z_2\end{vmatrix} \cdot \mathbf{j} \quad +\begin{vmatrix}x_1 & y_1 \\ x_2 & y_2\end{vmatrix} \cdot \mathbf{k}
\]
