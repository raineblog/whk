---
description: 本文系统介绍平面向量核心概念，涵盖有向线段、自由向量、向量的模及基向量。详细解析了直角与斜坐标系下的向量运算、点积的几何意义与极化恒等式，并探讨了向量分解与共线定理，帮助读者深度掌握平面几何知识。
---
...
![等和线](image-1-c95ded2.avif){ width="100%" }
