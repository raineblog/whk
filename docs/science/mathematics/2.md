...
![alt text](image-383b079.avif){ width=“90%" }
...
![alt text](image-7bbb72a.avif){ width="70%" }
...
$$\\begin{5x-11y \geq -22 \\ 2x+3y \geq 9 \\ 2x \leq 11}cases\\end{5x-11y \geq -22 \\ 2x+3y \geq 9 \\ 2x \leq 11}$$

$z = 10x + 10y, \max{z} = $ ？

1. 画图，数形结合。

   $$\\begin{5x-11y \geq -22 & \displaystyle \implies y \leq \frac{5}{11}x + \frac{1}{2} & \implies & \displaystyle y = \frac{5}{11}x + \frac{1}{2}\ 图像的下边 \\ 2x+3y \geq 9 & \displaystyle \implies y \geq -\frac{2}{3}x + 3 & \implies & \displaystyle y = -\frac{2}{3}x + 3\ 图像的上边 \\ 2x \leq 11 & \displaystyle \implies x \leq \frac{11}{2} & \implies & \displaystyle x=\frac{11}{2}\ 图像的左边 }cases\\end{5x-11y \geq -22 & \displaystyle \implies y \leq \frac{5}{11}x + \frac{1}{2} & \implies & \displaystyle y = \frac{5}{11}x + \frac{1}{2}\ 图像的下边 \\ 2x+3y \geq 9 & \displaystyle \implies y \geq -\frac{2}{3}x + 3 & \implies & \displaystyle y = -\frac{2}{3}x + 3\ 图像的上边 \\ 2x \leq 11 & \displaystyle \implies x \leq \frac{11}{2} & \implies & \displaystyle x=\frac{11}{2}\ 图像的左边 }$$
...
$$
\\begin{y \geq x \\ x + y \leq 2 \\ x \geq a}cases\\end{y \geq x \\ x + y \leq 2 \\ x \geq a}
$$
...
- 求 $(2x+y)_{\mathrm{max}}$：$\\begin{x-y\leq 0 \\ x+y\leq 2}cases\\end{x-y\leq 0 \\ x+y\leq 2}\xRightarrow{\mathrm{Add\ }} x\leq 1\implies y\leq 1\implies (2x+y)_{\mathrm{max}}=3$
...
$$
\\begin{ 0<a<b<c<1 \\ b\geq 2a \ \ \ \mathrm{or}\ \ \ a+b\leq 1 }cases\\end{ 0<a<b<c<1 \\ b\geq 2a \ \ \ \mathrm{or}\ \ \ a+b\leq 1 }
$$
...
- 注意到 $c$ 的约束条件是最少的，首先考虑消去它，得到
    ...
    $$\\begin{0<x \\ x<y \\ y<1 \\ y\geq 2x\ \ \ \mathrm{or}\ \ \ x+y\leq 1}cases\\end{0<x \\ x<y \\ y<1 \\ y\geq 2x\ \ \ \mathrm{or}\ \ \ x+y\leq 1}$$
