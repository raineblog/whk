---
title: "空间向量详解：基底展开与坐标构造及三维几何应用"
description: "本文系统阐述空间向量的定义、坐标系构建与基本运算，详细推导平面方程的点法式与一般式，进而分析点到面、点到线、线到线及面到面的距离公式，解释线与面的夹角、面与面的夹角，并介绍法向量叉乘、混合积及齐次坐标在三维变换中的应用，适用于高中几何与大学线性代数学习。"
summary: "系统阐述空间向量定义、坐标构建、平面方程与距离角度计算，涵盖叉乘、齐次坐标等高级应用，适用于几何与线性代数学习，与考试复习紧密结合。"
tags:
  - "空间向量"
  - "坐标系"
  - "基底"
...
|  | 平面向量 | 空间向量 |
| :-: | :-: | :-: |
| <nowrap>基底分解</nowrap> | $\bm a=(x,y)=x\bm e_1+y\bm e_2$ | $\bm a=(x,y,z)=x\bm e_1+y\bm e_2+z\bm e_3$ |
...
```md {admonition="note" title="一个朴素方法"}
