...
常见的含硫矿石：黄铁矿（$\ce{FeS2}$）、黄铜矿（$\ce{FeCuS2}$）、辰砂朱砂（$\ce{HgS}$）、雄黄（$\ce{As4S4}$）、雌黄（$\ce{As2S3}$）、芒硝（$\ce{Na2SO4*10H2O}$）、生石膏（$\ce{CaSO4*2H2O}$）、熟石膏（$\ce{2CaSO4*H2O}$）。
...
- 黑火药：$\ce{S + 2KNO3 + 3C ->[点燃] N2 + 3CO2 + K2S}$（一硫二硝三木炭）。
