...
置换反应可以用通式 $A + BC ightarrow AC + B$ 表示。所有置换反应都属于氧化还原反应，因为必有单质参与，化合价一定发生变化。我们不妨按照物质的种类和反应环境分类，按照金属、非金属置换金属、非金属（共 $4$ 类），以及在水溶液中、非水溶液中的反应。高中阶段较为常见的包括铝热反应、镁在二氧化碳中的燃烧，单质碳还原二氧化硅、氯气氧化氨气（生成氮气和氯化铵）、铁和高温水蒸气生成四氧化三铁。
