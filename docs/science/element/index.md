---
description: 系统介绍物质的组成与分类、元素的单质与化合态、氧化物类型、置换反应、酸碱盐、电解质、分散系、金属与稀有气体性质及其工业应用，涵盖氧化还原、方程式配平及常见颜色和焰色等化学基础知识。
---
...
2. **核心反应**：氧化还原调节（如 $\ce{Fe^2+ -> Fe^3+}$）、络合溶解、沉淀转化。

3. **分离提纯**：调 pH 值沉淀杂质、萃取与反萃取、重结晶、洗涤（水洗、醇洗、酸洗）。

4. **产品获取**：蒸发浓缩、冷却结晶、过滤、干燥（恒温干燥、真空干燥）。
...
- **调 pH，控沉淀**：根据 $K_{sp}$ 计算沉淀 pH 范围，实现杂质的分步沉淀。
...
- **其他常见金属（$Li, Na, K, Mg, Al, Zn$等）**：通常为**银白色**。
