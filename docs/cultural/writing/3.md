---
description: 汇总英语读后续写高分语料与范文，系统讲解情感描写、环境渲染、动作叙述、衔接修饰等写作技巧，以久别重逢、打猎迷路等例文示范，帮助考生提升表达力与应试水平。
---
...
2. 非谓语动词开头（状态铺垫）：◦ Doing/Done..., sb did sth. ◦ Exhausted from the long journey, the traveler fell asleep immediately. (长途跋涉筋疲力尽，旅行者立刻睡着了)。
3. 情绪倒装（强调核心）：◦ So + 形容词 + was sb that + 从句。◦ So absorbed was she in her book that she didn't notice me enter. (她如此专心读书，以至于没注意到我进来)。实战应用建议：Show, Don't Tell
...
2. **`While the weather was still cold, ...`** $\rightarrow$ (While 引导的对比句)
    - *解析*：运用“天气冷”与“心情暖”的对比，增强文学色彩。
3. **`Never had Emily felt so grateful...`** $\rightarrow$ (否定词置于句首的全部倒装)
    - *解析*：**全篇最高光句式！** 用 `Never had I...` 表达强烈的情感，是拿到 A 档语言分的关键。
4. **`...knowing that this unexpected detour had brought...`** $\rightarrow$ (现在分词引导的伴随状语)
