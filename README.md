...
-   **在线阅读**：通过 MkDocs Material 实时渲染，支持公式搜索、暗黑模式，提供最舒适的阅读体验。

    [:octicons-arrow-right-24: 立即前往](https://raineblog.dpdns.org/whk/)

-   **离线 PDF**：由 GitHub Actions 自动构建的最新版 PDF 文档，带目录索引，方便打印与离线查阅。

    [:octicons-download-24: 点击下载](https://github.com/raineblog/whk/releases)
