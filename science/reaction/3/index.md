...
- **活度**：可以理解为物质的"有效浓度"。活度 = 活度系数（$gamma$）$times$ 浓度（$c$）。
...
![alt text](/static/image/image-3.da9cfb9969.avif){width="100%"}
...
![alt text](/static/image/image-4.5ac7edd510.avif){width="100%"}
...
![alt text](/static/image/image-7.cb4034699c.avif){width="90%"}
三大守恒式及其书写：
...
- **浓度排序**：
  ...
  2. **比较 $con\{NH4+}$ 和 $con\{Cl-}$**：$ce\{Cl-}$ 完全来自于
     $ce\{HCl}$，混合后浓度稀释一半，为 $pu\{0.5E-2 mol/L}$。$ce\{NH4+}$
     主要来自于反应生成的 $ce\{NH4Cl}$，其量与消耗的 $ce\{HCl}$
...
将 $pu\{0.2 mol/L}$ 的 $ce\{NH4NO3}$ 溶液与 $pu\{0.1 mol/L}$ 的 $ce\{NaOH}$
溶液等体积混合（$pH > 7$）
...
- **浓度排序**：
  ...
  2. **利用 $pH > 7$**：溶液呈碱性，说明氨水的电离
     ...
     的消耗比 $ce\{NH3\*H2O}$ 的消耗要多**（或者说 $ce\{NH3\*H2O}$ 的生成比
     $ce\{NH4+}$ 的生成多）。

     - 因此，相比于反应结束时设想的 $pu\{0.05 M}$，实际上 $con\{NH4+}$
       会略微 **小于** $pu\{0.05 M}$，而 $con\{NH3\*H2O}$ 会略微 **大于**
       $pu\{0.05 M}$。
...
将 $pu\{0.2 mol/L}$ 此处为 $ce\{CH3COONa}$ 与 $pu\{0.1 mol/L}$ $ce\{HCl}$
溶液等体积混合（$pH \< 7$）
...
- **等效溶液**：混合后总体积为 $2V$，溶液等效于 **$pu\{0.05 mol/L}$
  ...
  $ce\{NaCl}$ 的混合溶液**。这是一个 $con\{CH3COOH} \approx \con\{CH3COO-}$
  的缓冲体系。
...
- 等体积等浓度：
  ...
  <img alt="alt text" src={image5} />\{width="100%"}

- 等体积等 $pH$：

  <img alt="alt text" src={image6} />\{width="100%"}

  <img alt="alt text" src={image7} />\{width="100%"}
