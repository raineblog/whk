...
`<img src="../pka.svg" width="90%" alt="alt text">`{=html}
...
- **反应后溶质**：反应消耗了全部的 $\ce{HCl}$，生成了等量的
  $\ce{NH4Cl}$，同时还有大量剩余的
  $\ce{NH3*H2O}$。因此，混合后的溶液等效于一个 **$\ce{NH3*H2O}$ 和
  $\ce{NH4Cl}$ 的混合溶液**，且
...
- **浓度排序**：
  ...
  2.  **利用 $\pH > 7$**：溶液呈碱性，说明氨水的电离
      ($\ce{NH3*H2O <=> NH4+ + OH-}$) 程度大于铵根的水解
      ($\ce{NH4+ + H2O <=> NH3*H2O + H+}$)。这意味着体系中 **$\ce{NH4+}$
      ...
      - 结论是
        **$\con{NH4+} > \pu{0.05 mol/L}$**。（*注：此处定性判断与守恒计算出现矛盾，以**电荷守恒**为准*）。

      - 既然 $\con{NH4+} > \pu{0.05 mol/L}$，根据物料守恒
        $\con{NH4+} + \con{NH3*H2O} = \pu{0.1 mol/L}$，则必然有
        **$\con{NH3*H2O} < \pu{0.05 mol/L}$**。
