...
1. **统一性**：组成细胞的化学元素在**无机自然界中都能够找到**，没有一种化学元素是细胞所特有的。这说明生物界与无机自然界在物质组成上具有统一性。
1. **差异性**：细胞中各种元素的**相对含量与无机自然界大不相同**。例如，地壳中含量最多的元素是氧（O）、硅（Si）、铝（Al），而细胞中含量最多的元素是氧（O）、碳（C）、氢（H）和氮（N）。
...
许多元素通过参与组成特定的化合物来执行生理功能：

1. **镁（Mg）**：是构成**叶绿素**分子的必需元素，缺镁会影响光合作用，导致叶片变黄。
1. **铁（Fe）**：是构成**血红蛋白**的重要成分，缺铁会导致缺铁性贫血。
1. **碘（I）**：是合成**甲状腺激素**的重要物质，缺碘会导致地方性甲状腺肿。
1. **钙（Ca）**：是骨骼和牙齿的主要成分。血液中钙离子含量过低会引起**抽搐**，过高则会导致**肌无力**。
1. **磷（P）**：是构成**ATP、核酸、磷脂、细胞膜和细胞核**的重要元素。
1. **硼（B）**：能促进花粉的萌发和花粉管的伸长。缺硼时植物会表现为“**花而不实**”（如油菜）或“**有蕾无铃**”（如棉花）。
1. **锌（Zn）**：与多种酶的活性有关，能促进生长发育，缺锌会导致性器官发育不良。

在细胞中，化学元素绝大多数以**化合物**的形式存在（如水、蛋白质、核酸、糖类和脂质），少数以**离子**的形式存在。

**易错易混辨析**：

- **大量元素与微量元素**：划分标准仅是**含量**，而非生理作用的大小；两者都是生物体所必需的必需元素。
- **必需元素与非必需元素**：并非生物体内的所有元素都是必需的。例如，铅（Pb）可能存在于生物体内，但它不是必需元素。
...
> 【苏教版】当某些元素缺乏或过剩时，作物会在形态上表现出明显的症状。传统农业就是针对这些症状，判断作物中哪些元素可能缺乏或过剩，进而针对性地施用肥料。当植物缺乏某种元素时，植物会表现出该种元素缺乏症，甚至死亡。传统农业根据植物的元素缺乏症，往往会有针对性地向农田投入化肥，但对投入化肥的种类和数量做不到精细管理，可能造成一些营养元素的过剩。过剩的元素也会对农田土壤环境造成污染。精准农业能根据农田的土壤元素状况和作物的元素缺乏或过剩状况，实施定位、定量的精准施肥，高效地利用各类农业资源，取得较好的经济效益和环境效益。
>
...
1. **生理功能明确**：该元素直接参与植物的新陈代谢，且其功能不能被其他元素完全替代。
1. **缺乏症特异性**：缺少该元素时，植物会表现出特定的缺乏症状，只有补充该元素后，植物才能恢复正常。
...
1. **吸收方式**：矿质离子主要通过**主动运输**的方式进入根细胞，这需要消耗细胞呼吸产生的能量（ATP）并依赖膜上的载体蛋白。
1. **浓度影响与“烧苗”**：正常情况下，根毛细胞液浓度大于土壤溶液浓度，水分通过渗透作用进入根部。若一次性施肥过多，土壤溶液浓度过高，会导致细胞失水，产生\*\*“烧苗”\*\*现象，引起植株萎蔫。
...
1. **施用有机肥**：有机肥经微生物分解后，能持续缓慢地提供 **CO₂ 和无机盐**，改善土壤结构，提高作物产量。
1. **微量元素补给**：虽然需求量小，但一旦缺乏会对产量产生毁灭性影响，应注意叶面喷施或基肥补给。
1. **精准农业**：利用现代技术对土壤进行测定，实施定位、定量的精准施肥，以减少环境污染并提高资源利用率。
...
\*\*分光光度法（Spectrophotometry）\*\*是一种利用物质对电磁辐射（光）的吸收、发射或散射特性，对物质进行定性或定量分析的科学技术。在生物化学和分子生物学研究中，它是定量测定生物分子（如蛋白质、糖类、核酸、维生素等）含量的最常用且高效的手段之一。

以下是分光光度法的详细展开讲解：

分光光度法的定量基础是**朗伯 - 比尔定律**，它描述了吸光度与物质浓度及光程之间的线性关系。

1. **基本公式**：

   A = \\varepsilon \\cdot c \\cdot l

   - **A（吸光度，Absorbance）**：指溶液对光的吸收程度。在分光光度计中，它被定义为透光率（T = I/I_0）倒数的对数，即 A = \\lg(I_0 / I)。
   - **\\varepsilon（摩尔消光系数）**：是吸光物质在特定波长下的特征常数，受化合物性质、溶剂和溶液 pH 值的影响。
   - **c（浓度）**：溶液中吸光物质的摩尔浓度。
   - **l（光程/路径长度）**：光线通过样品的距离，通常由比色杯的宽度决定。

1. **物理本质**：当一束单色光通过样品时，样品的溶质分子会有一定概率吸收光子，从而导致光束强度的减弱。在光程固定的情况下，溶液的浓度越高，吸收的光子越多，吸光度值（A）也就越大。

分光光度计是执行该分析的核心仪器，其主要组件包括：

- **光源**：通常使用钨灯或氘灯发射广谱连续光。
- **单色器（Monochromator）**：这是分光光度计与普通比色计的主要区别。它利用**棱镜或光栅**将广谱光色散，并从中筛选出特定波长的单色光。
- **样品池（比色杯/Cuvette）**：用于盛放待测液，通常具有光学平坦的面，以保证光路垂直穿过。
- **检测器**：测量穿过样品后的透射光强度，并将其转换为电信号。

在生物学实验中（如测定蛋白质浓度），通常遵循以下步骤：

1. **制作标准曲线**：
   - 配制一系列已知浓度的标准溶液。
   - 在特定波长下测量它们的吸光度。
   - 以浓度为横坐标、吸光度为纵坐标绘制曲线。在一定范围内，这应是一条通过原点的直线。
1. **样品测定**：测量未知浓度样品的吸光度值。
1. **结果换算**：根据标准曲线或回归方程，计算出样品的实际浓度。

分光光度法广泛应用于检测分子的特征吸收峰：

- **蛋白质定量**：蛋白质中的芳香族氨基酸（如**色氨酸和酪氨酸**）在 **280 nm** 波长处有强烈的紫外吸收。此外，也可以利用双缩脲反应生成的紫色络合物在 **540 nm** 处进行比色测定。
- **核酸检测**：DNA 和 RNA 在 **260 nm** 处有特征吸收峰。通过测量 A\_{260}/A\_{280} 的比值，可以判断核酸样品的纯度（纯 DNA 约为 1.8，纯 RNA 约为 2.0）。
- **光合色素测定**：叶绿素 a 和叶绿素 b 分别在不同波长（如 **665 nm 和 649 nm**）有最大吸收。通过分光光度计测定提取液的吸光度，可以精确计算出叶片中各种色素的含量。
- **酶活性分析**：通过监控反应底物或产物（如 NADH 在 340 nm 处的吸光度变化）的变动速度，可以测定酶的催化活性。

技术变体与扩展：

1. **荧光分光光度法 (Fluorospectrophotometry)**：利用某些物质受光激发后发射荧光的特性进行分析。其灵敏度通常比普通紫外 - 可见分光光度法高出 2 到 3 个数量级。
1. **显微分光光度术 (Microspectrophotometry)**：结合了显微镜和分光光度计的功能，可用于测定单个细胞或亚细胞结构内化学成分的含量。
1. **双波长分光光度法**：利用两束不同波长的光交替通过样品，能有效消除浑浊样品或背景干扰的影响。
...
20 世纪初，美国生物学家威尔逊（E. B. Wilson）曾预测：“一切生物学问题的答案最终都要到细胞中去寻找。”今天，生物学研究的众多重大成果证明了这一预测的正确性。
...
1. 列文虎克用自制的显微镜，观察到不同形态的细菌、红细胞和精子等（第一次观察到了活细胞）。

1. 马尔比基用显微镜广泛观察了动植物的显微结构，如细胞壁和细胞质。

   注意：有些地方会说是微细结构，但这不是太研究，有的时候会认为微细结构是亚显微结构，而亚显微结构则是电子显微镜才能看到的，也称为超微结构（亚显微结构和超微结构指代几乎等同，在侧重点上稍有不同，亚显微结构与光学显微镜下观察到的显微结构相对，而超微结构侧重于电子显微镜下的具体大分子排布和细胞器精细构造）。
...
自然界的生物千差万别、种类繁多，组成这些生物体的细胞形态结构和功能各异，但又具有许多共同的特征。直到 17 世纪中叶，第一台光学显微镜制成后，科学家才发现细胞。因为人眼的分辨率只有约 0.2 mm，而光学显微镜的分辨率可达人眼的 1000 倍，所以利用光学显微镜可以观察到微小的细胞。
...
现在已经知道，可见光的波长范围一般为 380～760 nm，因此限制了以可见光为光源的光学显微镜的分辨率，使其最大放大倍数受到很大限制。要提高显微镜的放大倍数，科学家们只能另辟蹊径。20 世纪 30 年代初，德国青年科学家卢斯卡（E. Ruska，1906—1988）等利用高能电子束波长很短的特点，制造出能够放大 10 000 倍的电子显微镜。由于此项贡献，卢斯卡等人获得 1986 年诺贝尔物理学奖。目前使用的电子显微镜已经能把观察的物体放大上百万倍。常用的电子显微镜有透射电子显微镜（transmission electron microscope）和扫描电子显微镜（scanning electron microscope）。

电子显微镜（Electron Microscope, EM）自20世纪30年代诞生以来，已成为现代科学研究中观察细胞亚显微结构的核心工具。它利用**电子束**代替可见光作为“光源”，并利用**电磁场**代替玻璃透镜进行聚焦。

透射电子显微镜是研究细胞内部细微结构最常用的工具。

- **工作原理**：TEM的操作原理与光学显微镜相似，但它是让一束高能电子束**穿透**样品。样品中不同部位的密度不同，电子被散射的程度也不同。未被散射的电子透过样品后，经电磁透镜放大，最终在荧光屏上形成反映样品内部结构的“投影”或“阴影图像”。
- **分辨率与放大倍数**：TEM具有极高的分辨率，通常可达0.1~0.2 nm（约为氢原子直径的2倍），有效放大倍数可达上百万倍。
- **样品要求**：由于电子束穿透力有限，样品必须被切成**极薄的切片**（通常厚度在20~100 nm之间）。
- **应用场景**：主要用于观察细胞器（如线粒体、叶绿体、核糖体）、细胞膜的“暗-亮-暗”三层结构以及大分子的超微结构。

扫描电子显微镜主要用于研究生物样品的**表面形貌**。

- **工作原理**：SEM利用一束极细的电子探针在样品表面进行**逐点扫描**。电子束与样品相互作用会激发出二次电子等信号，探测器收集这些信号并将其转化为图像。其成像反映的是样品表面的凹凸高低，因此具有强烈的**立体感**。
- **分辨率与放大倍数**：放大倍数范围很广（从十几倍到几十万倍不等），分辨率一般比TEM略低，现代高分辨率SEM可达1~3 nm。
- **样品要求**：样品无需切片，但需要进行复杂的固定、脱水处理（如临界点干燥），并通常在表面喷涂一层极薄的**重金属膜**（如金），以增加导电性并激发更多信号。
- **应用场景**：适合观察细胞、组织或固体材料的表面细节，如内耳毛细胞的纤毛、花粉粒表面、蚊子复眼等。

| 区别维度      | 透射电子显微镜 (TEM)                       | 扫描电子显微镜 (SEM)                   |
| ------------- | ------------------------------------------ | -------------------------------------- |
| **观察目标**  | 细胞**内部**的超微结构（如细胞器、膜结构） | 样品**表面**的形貌特征                 |
| **成像方式**  | 电子束**穿透**样品成像                     | 电子束在样品表面**扫描**并收集反射信号 |
| **图像维度**  | **2D** 投影图（切片视图）                  | **3D** 立体效果图                      |
| **分辨率**    | 极高（通常优于SEM，可达0.2nm）             | 较高（通常在1~20nm之间）               |
| **样品制备**  | 需制成**超薄切片**（20~100nm）             | 需进行**金属喷涂**，无需切片           |
| **染色/喷涂** | 使用重金属盐（如铀、铅）进行**内染色**     | 在表面**喷涂**金或钯等导电金属层       |

共同点与局限性：

1. **无法观察活细胞**：两者都必须在**真空**环境下操作，且样品制备过程（固定、脱水、重金属染色等）会杀死生物样本，因此不能用于观察活体细胞的动态过程。
1. **昂贵与复杂**：相比光学显微镜，电子显微镜设备体积庞大、价格昂贵，样品的制备过程也极为精细复杂。
1. **图像颜色**：原始电镜图像均为**黑白**色，我们在教科书中看到的彩色电镜图通常是经过后期人工着色的结果。

此外，在更高层级的纳米研究中，还存在**扫描隧道显微镜（STM）**和**原子力显微镜（AFM）**，它们的分辨率更高，甚至可以观察到单个原子的排布。
...
1. **独立的蛋白质合成系统**：它们拥有自己的**核糖体（70S）**，其大小、结构及对某些抗生素（如氯霉素）的敏感性均与细菌一致，而与细胞质中的 80S 核糖体不同。
1. **双层膜结构**：线粒体和叶绿体具有双层膜。**内膜**的化学组成与细菌质膜相似（含有褶皱），而**外膜**则与宿主细胞的质膜（或食物泡膜）更为接近。
1. **分裂方式**：它们不随细胞核的分裂而分裂，而是像细菌一样通过**二分裂**进行增殖。
1. **共生现象的普遍性**：自然界中存在许多现成的实例，如双小核草履虫体内的某些共生细菌，或造礁珊瑚与虫黄藻的共生，证明了这种细胞间的深度协作是完全可能的。
...
> 1. 线粒体和叶绿体中都含有 DNA、RNA 和核糖体，是半自主性的细胞器。它们自主生长，都具有合成自身某些蛋白质的能力。
> 1. 线粒体、叶绿体和原核细胞中所含的 DNA 均为环状分子，不含组蛋白，而真核细胞的核 DNA 则为线状，并与组蛋白结合形成染色体。
> 1. 细菌、线粒体和叶绿体的蛋白质合成均可受氯霉素和红霉素的抑制，而真核细胞的蛋白质合成对这些抗生素不敏感。反之，亚胺环己酮能抑制真核细胞的蛋白质合成，而对线粒体、叶绿体和细菌的蛋白质合成无抑制效应。
> 1. 线粒体和叶绿体能以分裂的方式进行增殖，这与细菌的繁殖方式相似，但是它们的分裂与所在细胞的分裂不同步。另外两者均能在异源细胞内长期存在，例如，鸡胚细胞的线粒体引入小鼠体外培养的成纤维细胞后，第四代小鼠细胞内仍可见鸡的线粒体；叶绿体在特殊软体动物细胞内能长期存在。
> 1. 叶绿体的基因组和光合系统与蓝细菌等原核生物极为相似。
>
...
质膜上的蛋白质称为膜蛋白，有的覆盖在膜表面，有的镶嵌或贯穿在磷脂双分子层中。细胞的功能与膜蛋白种类和含量有关，有些细胞的膜蛋白仅占膜成分的 25%，有些则高达 75%。质膜中还有少量的糖，约 93% 与膜蛋白相连，形成糖蛋白；约 7% 与膜脂相连，组成糖脂。质膜内外两侧的分子并不对称，糖脂和糖蛋白上的糖均分布在质膜外侧，具有保护质膜和识别外界信息等功能。
...
一些实验表明，生物膜并不是刚性的固态结构。1970 年，科学家进行了著名的人鼠细胞融合实验：先通过一些方法使人和小鼠的细胞融合成一个细胞，再用绿色荧光染料标记小鼠细胞表面的蛋白质分子，用红色荧光染料标记人细胞表面的蛋白质分子。开始时，融合的细胞一半呈现绿色，一半呈现红色。在 37 ℃下培养 40 min 后，两种颜色的荧光在整个细胞中都呈均匀分布。这表明细胞膜的蛋白质是呈流动状态的。
...
肥皂的主要成分与磷脂结构类似，是一端具有亲水性，另一端具有疏水性的两性分子。洗涤时，肥皂中两性分子的疏水端与油脂结合，将油脂包围起来，亲水端与周围的水分子结合，这样，被包裹的油脂在水中分散并形成乳浊液，再经过摩擦、振动，就被水冲洗掉了。这就是肥皂等去污剂去污的基本原理。
...
1. 定向排列与包裹（微团形成）：在洗涤过程中，肥皂分子的疏水端会避开水，主动与衣物或皮肤上的油脂结合并将油脂包围起来；而亲水端则朝向外侧与周围的水分子结合。随着肥皂浓度的增加，这些分子会形成一种球状聚集体，称为**微团（Micelle）**：

   - **微团内部**：由无数个肥皂分子的疏水尾部组成，它们像一个“避风港”，将油垢卷入其中并紧紧锁住。
   - **微团表面**：布满了带电的亲水头部，确保整个聚集体能够稳定地悬浮在水中。

1. 乳化与分散：通过手搓或洗衣机的揉搓、振动（机械作用），被肥皂分子包裹的油垢会从物体表面脱落，分解成极小的液滴分散在水中，这一过程称为**乳化（Emulsification）**。由于微团表面带有相同的电荷（如阴离子），它们之间会产生静电斥力，防止油滴重新聚集或再次沉积在物体表面。

1. 机械移除与冲洗：最终，这些被包裹在微团中的油垢和随之粘附的微生物（细菌、病毒等）形成**乳浊液**。通过大量的清水冲洗，污垢随水流被机械性地带走，从而达到去污和\*\*除菌（Degerming）\*\*的目的。
...
质膜的基本骨架是磷脂双分子层。磷脂分子亲水性的头部朝向细胞内外两侧，疏水性的尾部相对，在磷脂双分子层内部形成一层疏水的屏障。紧密排列的磷脂分子不允许大分子物质进出，疏水屏障将细胞内外的极性小分子和离子等物质隔开，从而将细胞与生活环境分开，使细胞内部形成相对稳定的环境。临床上应用这个原理可以判断细胞是否有损伤。例如，正常情况下谷丙转氨酶（ALT）存在于人体肝细胞中，而血清中含量极少。当肝细胞质膜受损时，ALT 会流出细胞而进入血液。因此，血清中 ALT 量的变化可作为临床上诊断肝功能的指标之一。
...
细胞膜上的蛋白质统称为膜蛋白。膜蛋白也和磷脂分子一样，有水溶性部分和脂溶性部分。通常细胞的功能越多，其膜蛋白的种类和数量就越多。有些膜蛋白选择性地吸收或排出特定物质，控制其进出细胞，这类膜蛋白称为转运蛋白。例如，细胞吸收离子、葡萄糖、氨基酸等营养物质都需要通过特定的转运蛋白来完成。有些膜蛋白催化特定化学反应，例如，小肠上皮细胞的某些膜蛋白可促进食物中营养物质的消化分解。同一组织的相邻细胞间通过某些膜蛋白紧密连接在一起。某些膜蛋白接收外界信息或刺激，激活细胞内相应生理生化反应，在细胞与外界的信息交流和细胞识别中发挥重要作用，如胰岛素受体。细胞膜的功能主要通过膜蛋白来实现。
...
20 世纪 80 年代，有人提出生物膜有许多胆固醇聚集的微结构区，就像水面上漂浮的竹筏一样，称为脂筏模型。脂筏位于生物膜的外侧，胆固醇与磷脂相互作用，形成了脂筏的基本结构。一些膜蛋白与脂筏表面的化学基团结合，被“锚定”在一起，构成了生物膜上分子排列紧密、结构相对稳定的特定区域。所以，脂筏像个蛋白质停泊平台一样，有助于蛋白质执行相应功能。这一模型可以解释生物膜的某些性质和功能，但仍需要更多的证据支持。
...
1. **初生壁（Primary wall）**：在细胞生长过程中形成，位于胞间层内侧，较薄且富有弹性（含纤维素、半纤维素和果胶），允许细胞伸长。
1. **次生壁（Secondary wall）**：细胞停止生长后，在初生壁内侧沉积形成。它比初生壁厚且坚硬，常含有木质素，起支持和保护作用。
...
1. 其 70S 核糖体在结构上与细菌核糖体更为接近。
1. 双层膜结构中，内膜与细菌质膜成分相似，外膜则与宿主细胞膜成分相近。
...
1. **COP I 有被囊泡**：产生于**高尔基体**，负责将内质网驻留蛋白等“逃逸”物质回收转运回内质网（逆向转运），也参与高尔基体内部的物质运输。
1. **网格蛋白有被囊泡（Clathrin-coated vesicle）**：可产生于高尔基体或细胞膜。它们介导从高尔基体向溶酶体或质膜的运输，以及受体介导的胞吞作用。
1. **特殊类型**：包括**突触小泡**（存储神经递质）、**分泌囊泡**（储存分泌蛋白）以及参与细胞自噬的**自噬体**等。
...
1. **运输（Transport）**：囊泡离开供体膜后，通常依赖**细胞骨架**（主要是微管）作为轨道。**马达蛋白**（如驱动蛋白 Kinesin 或动力蛋白 Dynein）利用 ATP 提供的能量，牵引囊泡沿轨道定向移动。
1. **锚定与系留（Docking & Tethering）**：囊泡表面特有的 **Rab 蛋白**被靶膜上的**束缚蛋白**识别并结合，使囊泡停靠在特定的目的地。
1. **融合（Fusion）**：涉及 **SNARE 蛋白复合体**的相互作用。囊泡上的 **v-SNARE** 与靶膜上的 **t-SNARE** 像绞车一样互相缠绕，克服膜表面的静电斥力，使两层膜紧密接触并最终融合，将其中的“货物”释放。
...
1. 伞藻（Acetabularia）实验：伞藻是生活在热带海域的大型单细胞绿藻（长 2~5cm），由**伞帽、伞柄和假根**三部分构成，**细胞核位于基部的假根内**。实验常选用“伞形帽”和“菊花形帽”两种伞藻作为材料。
   1. 伞藻“嫁接”实验：
...
1. 总结与核心考点：
   ...
   1. **遗传信息库**：细胞核之所以能成为控制中心，是因为它含有遗传物质 DNA，DNA 储存着细胞进行生命活动的“蓝图”。
   1. **应用延伸（克隆技术）**：
      - 美西螈核移植实验进一步证实了动物**细胞核具有全能性**（虽然体细胞克隆比胚胎细胞克隆难度大得多）。
      - 著名的\*\*克隆羊“多莉”**和**克隆猴“中中”“华华”\*\*的诞生，本质上都是这些单细胞核移植实验在高等动物身上的大规模应用。
   1. **结构适应功能**：在这些实验中，细胞表现出明显的**极性**（如涡虫再生由前向后呈梯度递减），这体现了生命系统内部精密的调控机制。
...
在植物生理学中，\*\*质外体（Apoplast）**与**共质体（Symplast）\*\*是构成植物体内部物质运输和信号传递的两大主要网络系统。这两个系统相辅相成，共同维系着植物的生长、发育以及对环境的适应能力。

质外体是指植物活体组织中，**质膜（细胞膜）外围**所有不具有生命活性的、物理上相互连续的空间网络。

- **组成结构**：
  1. **细胞壁（Cell Walls）**：由纤维素、半纤维素和果胶构成的多孔网格，允许水分和微小溶质自由扩散。
  1. **细胞间隙（Intercellular Spaces）**：细胞间未完全紧贴的空隙，通常充满了饱和水汽或薄薄的水膜。
  1. **木质部死细胞（Xylem）**：成熟的导管和管胞已失去原生质体，其内部空腔是运输水分和矿物质的“高速公路”，也属于质外体。
- **运输特点（质外体途径）**：
  - **极速且低阻**：物质直接沿着细胞壁间隙扩散，不需要穿过任何细胞膜，阻力极小，速度极快。
  - **缺乏选择性**：由于不经过质膜，植物对质外体中的物质没有选择控制权，“泥沙俱下”。
  - **驱动力**：主要是蒸腾拉力和根压等物理力量。
- **生理功能**：
  - **水与矿质运输**：负责植物体内水分和无机盐的长、短途快速运输。
  - **信号中转**：质外体中含有多种酶（如过氧化物酶），在环境胁迫时作为信号分子（如 H_2O_2、ABA）的中转站。
  - **机械支撑**：细胞壁作为质外体核心组分，提供机械强度并防止细胞吸水涨破。

共质体是指植物体中所有活细胞的\*\*原生质体（Protoplast）\*\*通过特定结构相互连接、相互贯通所形成的统一生命网络。

- **物理基础——胞间连丝（Plasmodesmata）**：
  - 这是共质体的“灵魂”，是穿透细胞壁、沟通相邻细胞的原生质通道。
  - 通道中通常含有由内质网衍生而来的**连丝微管（Desmotubule）**。
  - 它使得整个植物体的活细胞膜和细胞质在空间上是连续的“大网”。
- **运输特点（共质体途径）**：
  - **受控且精准**：物质一旦进入共质体，其移动完全受细胞生命活动的选择性控制（通过质膜上的转运蛋白）。
  - **阻力较大**：由于原生质黏度大且通道狭窄，运输阻力明显高于质外体。
  - **加速机制**：胞质环流像搅拌机一样加速物质在细胞内的混合与传递。
- **生理功能**：
  - **养分精确分配**：严格筛选进入维管系统的物质，吸收营养，拒绝重金属等有害物质。
  - **有机物长途运输**：韧皮部的筛管细胞通过高度发达的共质体通道运送光合产物（如蔗糖）。
  - **发育协调**：通过胞间连丝传递蛋白质、RNA、激素等信号分子，同步调节植物的整体发育。

凯氏带（Casparian Strip）：质外体与共质体并非完全隔离，它们在**根部的内皮层**发生命运的交汇。

1. **结构**：内皮层细胞的径向壁和横向壁上沉积有木栓质和木质素，形成极强疏水性的**凯氏带**。
1. **作用**：凯氏带彻底截断了质外体途径的“高速公路”，迫使水分和离子必须跨越质膜进入内皮层细胞的细胞质（共质体）。
1. **意义**：这是植物的“安检海关”，确保了进入木质部导管的物质都经过了细胞的严格筛选，同时防止了中柱内的养分倒流回土壤。

| 特性           | 质外体 (Apoplast)      | 共质体 (Symplast)        |
| -------------- | ---------------------- | ------------------------ |
| **空间性质**   | 非生活系统（细胞膜外） | 生活系统（细胞膜内）     |
| **主要组成**   | 细胞壁、细胞间隙、导管 | 细胞质、胞间连丝、筛管   |
| **运输阻力**   | 极小（像海绵、水管）   | 较大（受胞质黏度影响）   |
| **选择控制性** | 无选择性（物理性扩散） | 具高度选择性（生命调控） |
| **连续性**     | 在内皮层处被凯氏带阻断 | 通过胞间连丝保持全身连续 |
| **打个比方**   | 城市的下水道与公路网   | 城市的互联网与保密局     |

质外体负责**高效、大规模**的水分运输，而共质体负责**精细、受控**的营养筛选与信号指挥，两者共同构成了植物高度协调的体内环境。
...
1. 原生质层（Protoplast layer）：成熟植物细胞的“选择透过性屏障”
...
1. 植物细胞工程（原生质体的舞台）：在植物体细胞杂交技术中，原生质体是操作的对象。
...
1. **死细胞的辨别**：原生质层表现出选择透过性是以**细胞活性**为前提的。如果细胞死亡，原生质层会失去选择透过性，变为全透性，此时无法发生质壁分离。
1. **质壁分离空间填充物**：在质壁分离状态下，细胞壁与原生质层之间的空隙填充的是**外界溶液**，因为细胞壁是**全透性**的。
1. **实验选材**：观察质壁分离通常选用紫色洋葱鳞片叶**外表皮**，因为它有紫色大液泡，便于观察原生质层（由液泡体积变化推测）的位置变化。
1. **原生质滴**：这是一个极冷门的干扰项，指精子形成过程中浓缩的细胞质基质，与前两者无直接逻辑关联。
...
1. **自我保护机制**：溶酶体膜不会被自身的水解酶分解，可能的原因包括：膜成分经过高度糖基化等修饰，使酶难以发挥作用；或者膜上特定的电荷/基团能使酶远离膜结构。
1. **生物学功能**：
...
1. **受体识别与分拣**：在高尔基体的反面膜囊（TGN）上，**M6P 受体**识别并结合带有该标志的蛋白质。
1. **囊泡运输与成熟**：带有酶蛋白的区域出芽形成**有被小泡**（通常包被有网格蛋白），这些囊泡脱去包被后与**晚期内体**融合形成**内溶酶体**。在酸性环境下，酶与受体分离，受体返回高尔基体循环利用，而内溶酶体最终发育成熟为溶酶体。
...
1. **配位反应**：在**碱性环境**（由 A 液提供）下，蛋白质分子中的肽键能与双缩脲试剂中的 Cu^{2+}（由 B 液提供）发生反应。
1. **显色结果**：这种反应会生成一种**紫色**的复杂复（络）合物。溶液中紫色程度的深浅在一定范围内与蛋白质的浓度成正比。
1. **反应条件限制**：
...
1. **浸润**：使用镊子夹取尿蛋白试纸，将**黄色测试端**浸入待测样液中，取出后静置（通常建议等待约 30 秒以便反应充分）。
1. **重复对照**：以同样的方法用另一张试纸测试蒸馏水，观察现象。
1. **比色**：将试纸测试端显现的颜色与随试纸提供的**标准色板**进行实时对比。
...
1. **奢侈蛋白突变**：具有明显的组织特异性效应。突变不仅会引起原发组织的功能异常（如胰岛素缺陷导致糖尿病），还可能通过系统影响累及其他器官。例如苯丙酮尿症，原发缺陷是肝肾中的酶，但后果却是患者的智力低下。
...
1. **辅基（Prosthetic group）**：特指与蛋白质结合非常牢固，且为维持蛋白质活性所必需的辅助因子。例如，血红蛋白中的血红素就是一个典型的辅基。
1. **协同作用**：蛋白质框架为辅基提供精确的化学环境和物理定位，使其能以极高的效率和专一性进行反应。
...
1. 脂蛋白 (Lipoproteins) 是蛋白质与脂质（如三酰甘油、磷脂、胆固醇）结合形成的复合物。主要负责在血液或淋巴液中运输不溶于水的脂质。极低密度脂蛋白（VLDL）主要运输外源性甘油三酯和胆固醇。

1. 染色蛋白质 (Chromoproteins) 含有生色基团（辅基），使得蛋白质呈现特定颜色。

   - **血红素蛋白**：含有血红素辅基，如**血红蛋白**（携带氧气）和**细胞色素**（参与电子传递）。
   - **视紫质 (Rhodopsin)**：存在于视网膜中，由视蛋白与小分子**视黄醛**共价结合而成，是感光成像的基础。
   - **含金属色蛋白**：如含铜的**铜蓝蛋白**呈现亮蓝色。

1. 金属蛋白质 (Metalloproteins) 以金属离子作为辅因子或核心组成部分。许多酶需要金属离子才能发挥催化作用，如含锌的羧肽酶、含铁的细胞色素氧化酶。金属离子可以稳定蛋白质的活性构象，或者直接参与氧化还原反应中的电子转移。

1. 磷蛋白 (Phosphoproteins) 是指多肽链中的某些氨基酸残基（如丝氨酸、苏氨酸、酪氨酸）被磷酸化的蛋白质。磷酸化和去磷酸化是细胞内最重要的分子开关，可以调控蛋白质的活性状态、定位以及与其他分子的相互作用。

1. 核糖核蛋白 (Ribonucleoproteins, RNP) 虽然常被视为复杂的分子机器，但它们本质上是蛋白质与核酸（如 RNA）结合形成的复合物。**核糖体**是最大的核糖核蛋白复合物，由数种 rRNA 和 50 多种蛋白质组成，负责细胞内的蛋白质合成。

血红蛋白（Hemoglobin）是结合蛋白质的完美范例：

1. **蛋白质部分**：由四条多肽链（两条 \\alpha 链和两条 \\beta 链）组成其四级结构。
1. **非蛋白部分**：每条肽链都紧密结合一个**血红素**分子。
1. **核心机制**：血红素中心的铁原子能可逆地结合氧气。如果没有这个非蛋白的血红素辅基，单纯的珠蛋白无法执行运输氧气的功能。
...
1. **起始合成与 SRP 识别**：
   - 蛋白质在游离核糖体上起始合成。当新生肽链延伸至约 80 个氨基酸残基时，其 N 端的\*\*信号肽（SP）\*\*暴露出来。
   - 细胞质基质中的\*\*信号识别颗粒（SRP）\*\*识别并特异性结合信号肽，导致肽链延伸暂时停止，以防止新生肽在进入内质网前发生损伤或错误折叠。
1. **靶向内质网**：
   - SRP 引导“核糖体 - 新生肽”复合物与内质网膜上的\*\*SRP 受体（又称锚定蛋白）\*\*结合。
   - 核糖体随后附着到内质网膜的\*\*易位子（translocon）\*\*通道上，SRP 脱离并返回细胞质基质重复利用，肽链延伸恢复。
1. **进入内质网与初步加工**：
   - 新生肽边合成边穿过易位子进入**内质网腔**。在此过程中，信号肽通常被腔面上的信号肽酶切除。
   - 在内质网内，蛋白质在**分子伴侣**（如 BiP）的帮助下进行折叠和装配，并进行初步的**N-连接糖基化**修饰（将 14 糖的核心寡糖转移至天冬酰胺残基上）。
   - **质量监控**：只有正确折叠的蛋白质才能离开内质网。错误折叠的蛋白会被扣留并最终通过\*\*未折叠蛋白质反应（UPR）\*\*或泛素 - 蛋白酶体途径降解。
1. **高尔基体加工与分选**：
   - 正确折叠的蛋白通过**COPII 被膜小泡**转运至高尔基体。
   - 高尔基体作为细胞内的“交通枢纽”，对蛋白质进行进一步的修饰（如 O-连接糖基化、寡糖链修饰、蛋白质水解等）和分拣。
   - **分选去向**：
     - **溶酶体**：带有\*\*6-磷酸甘露糖（M6P）\*\*标志的蛋白质被高尔基体膜上的 M6P 受体识别，包裹进网格蛋白小泡，最终送往溶酶体。
     - **细胞膜与分泌**：其他蛋白质分选至细胞膜（成为膜蛋白）或通过**胞吐作用**（分泌蛋白）排至细胞外。分泌分为**连续性分泌**（所有细胞共有）和**调节性分泌**（仅存在于特化分泌细胞，需外部信号触发）。
     - **回收内质网**：带有**KDEL 信号序列**的内质网驻留蛋白若误入高尔基体，会被受体识别并通过**COPI 被膜小泡**逆向运回内质网。

翻译后转运途径涉及在游离核糖体上已完成合成的蛋白质，随后被转运至围绕膜的细胞器。

1. **定位至线粒体与叶绿体**：
   - 这类蛋白质前体带有**基质导入序列（MTS）**或**转运肽**。
   - 在细胞质伴侣蛋白（如 hsc70）的协助下，蛋白质保持非折叠状态，并由细胞器外膜（Tom）和内膜（Tim）上的**转位接触点**复合体转运进入。进入后信号序列被切除，蛋白重新折叠。
1. **定位至细胞核（门孔运输）**：
   - 亲核蛋白含有**核定位信号（NLS）**。
   - NLS 被细胞质中的**核转运受体（输入蛋白）**识别，在**Ran GTP 酶**提供能量的驱动下，蛋白质以完整的折叠构象通过**核孔复合体**进入细胞核。核内蛋白的 NLS 通常不被切除。
1. **其他去向**：
   - 含有特定序列的蛋白被引导至过氧化物酶体。
