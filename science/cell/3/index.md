...
![蛙胚胎形成和发育过程示意图|w90%](../image-15-749ac2a.avif)
...
![alt text|w100%](../image-51-69fb38e.avif)

![alt text|w100%](../image-52-dd3bd6d.avif)
...
![alt text|w90%](../image-53-367a4df.avif)
...
![alt text|w90%](../image-17-8e10ac4.avif)
...
![alt text|w100%](../image-39-edfb200.avif)
...
![胚胎分割技术示意与显微手术操作|w80%](../image-16-1a6980b.avif)
...
![alt text|w100%](../image-56-48795ca.avif)
...
![将胡萝卜韧皮部细胞培育成完整植株示意图|w70%](../image-31-f1bf66b.avif)
...
- 生产次生代谢产物：植物细胞除了能诱导形成完整植株外，还能像微生物一样在生物反应器里进行大规模的悬浮培养，用于生产重要的植物次生代谢产物。次生代谢产物是一类细胞生命活动非必需的小分子有机化合物，其产生和分布通常有种属、器官、组织以及生长发育时期的特异性。
  ...
  ![紫杉醇的大规模生产和功效|w90%](../image-10-483c3e7.avif)
...
![alt text|w100%](../image-32-ca71434.avif)
...
![运用植物体细胞杂交技术培育白菜—甘蓝流程图|w100%](../image-11-2fad314.avif)
...
![alt text|w100%](../image-34-cd2941e.avif)
...
![alt text|right|w40%](../image-33-48861b2.avif)
...
![alt text|w80%](../image-57-f80072a.avif)
...
![alt text|w60%](../image-58-c491320.avif)
...
![alt text|w100%](../image-37-4510ff5.avif)
...
![alt text|w100%](../image-38-dc9a465.avif)
...
![胚胎干细胞和成体干细胞分化潜能示意图|w100%](../image-13-44da22e.avif)
...
![获得诱导性多能干细胞示意图|w60%](../image-14-3f2c9af.avif)
...
![alt text|w100%](../image-18-09de536.avif)
...
![alt text|w100%](../image-35-475d506.avif)
...
![alt text|left|w50](../image-36-d6af93b.avif)
...
![alt text|w90%](../image-61-e3d21ac.avif)
...
![alt text|w60%](../image-62-367d42e.avif)
...
![成年动物体细胞克隆后代“多莉”的培育过程|w90%](../image-12-a7ea752.avif)
...
![alt text|w80%](../image-4-935faa7.avif)
...
- 定点突变：研究表明，人胰岛素样生长因子的结构和性质与人胰岛素高度相似，但它不像人胰岛素那样容易聚合形成多分子。比较这两种蛋白质的结构发现，人胰岛素样生长因子在与人胰岛素 B 链对应的第 28 位和第 29 位氨基酸分别是赖氨酸和脯氨酸，而人胰岛素在这两处的氨基酸序列正好颠倒，因而推测这是人胰岛素形成多分子形式的关键原因。为了证实这一猜想，需要更换人胰岛素这两个位点的氨基酸顺序。
  ...
  ![alt text|w60%](../image-23-4e90486.avif)
...
- 随机突变：随机突变以获得高效能酶分子。
  ...
  ![随机突变以获得高效能酶分子|w60%](../image-24-3083270.avif)
...
![alt text|w100%](../image-44-19aa9c1.avif)
...
![人胰岛素在胰岛 β 细胞中的生物合成|w80%](../image-26-429ba26.avif)
...
![采用基因工程技术在大肠杆菌中生产人胰岛素|w80%](../image-27-6ac9acb.avif)
...
![alt text|w60%](../image-46-1185c51.avif)
...
![alt text|w100%](../image-47-0e4a27b.avif)
...
- 限制性内切核酸酶：切割 DNA 分子的工具是限制性内切核酸酶，简称限制酶。这类酶主要是从原核生物中分离纯化出来的。迄今分离的限制酶有数千种，许多已经被商业化生产。它们能够识别双链 DNA 分子的特定核苷酸序列，并且使每一条链中特定部位的磷酸二酯键断开。
  ...
  ![alt text|w90%](../image-6-0faf96a.avif)
  ...
  ![限制性内切核酸酶识别特定 DNA 序列并在切割位点切开 DNA|w100%](../image-19-227fb4f.avif)
...
- DNA 连接酶：将切下来的 DNA 片段拼接成新的 DNA 分子，是靠 DNA 连接酶来完成的。1967 年，世界上几个实验室几乎同时发现了一种能够将两个 DNA 片段连接起来的酶，称之为 DNA 连接酶（DNA ligase）。在基因工程操作中，DNA 连接酶主要有两类：一类是从大肠杆菌中分离得到的，称为 E.coli DNA 连接酶；另一类是从 T4 噬菌体中分离出来的，称为 T4 DNA 连接酶。这两类酶都能将双链 DNA 片段"缝合"起来，恢复被限制酶切开的磷酸二酯键，但 E.coli DNA 连接酶连接具有平末端的 DNA 片段的效率要远远低于 T4 DNA 连接酶。
  ...
  ![DNA 连接酶作用示意图|w80%](../image-20-32bf9ce.avif)
...
- 将外源基因导入受体细胞中，为什么要使用载体呢？大部分 DNA 片段（尤其是目的基因）并不具备可遗传的自我复制能力，因为缺少复制所必需的特定 DNA 序列。而且，即便一个 DNA 片段能在原供体细胞中复制，这种复制能力一般情况下也难以在受体细胞中正常发挥。因此，要让外源 DNA 在受体细胞中复制，就需要一种合适的运载工具为其提供在受体细胞中复制的能力，这种用于重组 DNA 技术的运载工具称为载体。也就是说，任何具备在受体细胞中独立复制性能的 DNA 分子，理论上均可用作基因工程的载体。
  ...
  ![alt text|w40%](../image-7-0ace124.avif)
...
![PCR 的基本程序|w80%](../image-21-a6e54f7.avif)
...
![alt text|w100%](../image-b242dda.avif)
...
![alt text|w100%](../image-1-61c552e.avif)
...
![alt text|w100%](../image-42-40e340c.avif)
...
![alt text|w100%](../image-2-d777481.avif)
...
![alt text|w100%](../image-43-db452de.avif)
...
![alt text|w100%](../image-3-9f83429.avif)
...
![抗药性筛选法的工作原理|w100%](../image-22-c18a52d.avif)
