...
|  | 平面向量 | 空间向量 |
|:--:|:--:|:--:|
| `<nowrap>`{=html}基底分解`</nowrap>`{=html} | $\bm a=(x,y)=x\bm e_1+y\bm e_2$ | $\bm a=(x,y,z)=x\bm e_1+y\bm e_2+z\bm e_3$ |
...
`<img src="../480px-3D_Cartesian.svg.avif" width="40%" alt="空间直角坐标系">`{=html}
...
`<img src="../建系示例1.avif" width="100%">`{=html}
...
`<img src="../image-3.avif" alt="alt text">`{=html}
...
`<img src="../image-2.avif" alt="面面角与二面角">`{=html}
...
`<img src="../二面角1.avif" width="100%" alt="alt text">`{=html}
...
`<img src="../Right_hand_rule_cross_product.svg" width="70%">`{=html}
...
`<img src="../image-4.avif" alt="alt text">`{=html}
