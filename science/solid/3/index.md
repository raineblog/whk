...
![alt text](/static/image/image.a1891c123a.avif){width="100%"}
找截面有交线法和平行线法两个常用的方法，本人喜欢先用平行线，然后找交线。

![](/static/image/截面问题.54249acd5f.avif){width="80%"}
1. 连接被截的若干点。
