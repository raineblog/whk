...
::img\[alt text]\{src="../image-8.avif" width="90%"}
...
::img\[阴极射线实验]\{src="../image-5.avif" width="80%"}
...
::img\[alt text]\{src="../Gold\_foil\_experiment\_conclusions.svg" align="right" width="30%"}
...
::img\[基态激发态]\{src="../基态激发态.avif" width="60%"}
...
::img\[光谱的测定]\{src="../光谱的测定.avif" width="80%"}
...
::img\[能级交错]\{src="../能级交错.avif" width="70%"}
...
::img\[轨道表示式]\{src="../轨道表示式.avif" width="100%"}
...
::img\[alt text]\{src="../Helium\_atom\_QM.svg" width="60%"}
...
::img\[原子轨道]\{src="../原子轨道.avif" width="90%"}
...
::img\[轮廓图]\{src="../元素周期表轮廓图.avif" width="90%"}
...
::img\[分区]\{src="../元素周期表的分区.avif" width="90%"}
...
- 十字交叉法求丰度：
  ...
  ::img\[十字交叉]\{src="../十字交叉法.avif" width="50%"}
...
::img\[元素周期律]\{src="../元素周期律.avif" width="90%"}
...
::img\[半径]\{src="../共价半径和范德华半径.avif" width="70%"}
...
::img\[电离能]\{src="../铍电离能.avif" align="right" width="20%"}
...
::img\[第一电离能]\{src="../第一电离能.avif" width="90%"}

::img\[第一电离能折线图]\{src="../第一电离能折线图.avif" width="90%"}
...
::img\[电负性]\{src="../电负性.avif" width="90%"}

::img\[电负性折线图]\{src="../电负性折线图.avif" width="90%"}
