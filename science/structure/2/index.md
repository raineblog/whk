...
`<img src="../image-8.avif" width="90%" alt="alt text">`{=html}
...
`<img src="../image-5.avif" width="80%" alt="阴极射线实验">`{=html}
...
`<img src="../Gold_foil_experiment_conclusions.svg" align="right" width="30%" alt="alt text">`{=html}
...
`<img src="../image-7.avif" width="90%" alt="alt text">`{=html}
...
`<img src="../基态激发态.avif" width="60%" alt="基态激发态">`{=html}
...
`<img src="../光谱的测定.avif" width="80%" alt="光谱的测定">`{=html}
...
`<img src="../能级交错.avif" width="70%" alt="能级交错">`{=html}
...
`<img src="../轨道表示式.avif" width="100%" alt="轨道表示式">`{=html}
...
`<img src="../Helium_atom_QM.svg" width="60%" alt="alt text">`{=html}
...
`<img src="../原子轨道.avif" width="90%" alt="原子轨道">`{=html}
...
`<img src="../元素周期表轮廓图.avif" width="90%" alt="轮廓图">`{=html}
...
`<img src="../元素周期表的分区.avif" width="90%" alt="分区">`{=html}
...
- 十字交叉法求丰度：
  ...
  `<img src="../十字交叉法.avif" width="50%" alt="十字交叉">`{=html}
...
`<img src="../元素周期律.avif" width="90%" alt="元素周期律">`{=html}
...
`<img src="../共价半径和范德华半径.avif" width="70%" alt="半径">`{=html}
...
`<img src="../铍电离能.avif" align="right" width="20%" alt="电离能">`{=html}
...
`<img src="../第一电离能.avif" width="90%" alt="第一电离能">`{=html}

`<img src="../第一电离能折线图.avif" width="90%" alt="第一电离能折线图">`{=html}
...
`<img src="../电负性.avif" width="90%" alt="电负性">`{=html}

`<img src="../电负性折线图.avif" width="90%" alt="电负性折线图">`{=html}
