...
|:--:|:---|:--:|:--:|:--:|
| **\$\alpha\$ 衰变** | 释放 \$\ce{\^4_2He}\$ 核 | \$\ce{\^{238}*{92}U -\> \^{234}*\$}Th + \^4_2He | \$A-4, Z-2\$ | 弱（纸挡） |
| **\$\beta\^-\$ 衰变** | 中子转变为质子并释放电子 | \$\ce{\^{14}*6C -\> \^{14}\_7N + \^0*\$}e + \bar{\nu}\_e | \$A\$ 不变，\$Z+1\$ | 中（铝板） |
| **\$\beta\^+\$ 衰变** | 质子转变为中子并释放正电子 | \$\ce{\^{18}*9F -\> \^{18}\_8O + \^0*\$}e + \nu_e | \$A\$ 不变，\$Z-1\$ | 中（铝板） |
| **电子捕获** | 核捕获内层电子，质子变中子 | \$\ce{\^7_4Be + \^0\_{-1}e -\> \^7_3Li + \nu_e}\$ | \$A\$ 不变，\$Z-1\$ | \- |
| **\$\gamma\$ 衰变** | 核从激发态跃迁至基态释放光子 | \$\ce{^{A}\_{Z}X^\* -\> \^{A}\_{Z}X + \gamma}\$ | \$A, Z\$ 不变 | 强（铅砖） |

**统计规律与半衰期**：

- 衰变是**随机**的。**半衰期**（\$T\_{½}\$）是样品中一半原子核发生衰变所需的时间，由核本身结构决定，与外界物理、化学条件无关。
...
不同原子核的比结合能是不一样的，中等大小的核的比结合能最大（平均每个核子的质量亏损最大），这些核最稳定。原子核半径 \$R\$ 与质量数 \$A\$ 的关系为 \$R = R_0 A\^{⅓}\$，其中 \$R_0 \approx 1.2 \times 10\^{-15} \text{ m}\$。这表明原子核物质的密度近似为常数。
...
氢原子的光谱如图所示。光谱的结果显示氢原子只能发出一系列特定波长的光。1885 年，瑞士科学家巴耳末对当时已知的氢原子在可见光区的四条谱线，即图中 \$\ce{H}*{\alpha},\ce{H}*},\ce{H*{\gamma},\ce{H}*\$ 谱线作了分析，发现这些谱线的波长 \$\lambda\$ 满足一个简单的公式，即
...
<tbody>
<tr>
<td style="text-align: center;">主量子数 $n$</td>
<td style="text-align: center;">描述电子能层及离核远近</td>
<td style="text-align: center;">$n$ 越大，电子能量越高<br />
离核平均距离越远</td>
<td style="text-align: center;">$1, 2, 3, 4, 5, 6, 7$<br />
对应 $\text{K, L, M, N, O, P, Q}$</td>
</tr>
<tr>
<td style="text-align: center;">角量子数 $\ell$</td>
<td style="text-align: center;">描述电子云/轨道形状</td>
<td style="text-align: center;">$\text{s, p, d, f}$<br />
决定能级能量</td>
<td style="text-align: center;">$[0, n-1]$ 的整数<br />
$0$: $\text{s}$ 球形；$1$: $\text{p}$ 哑铃形；<br />
$2$: $\text{d}$ 花瓣形等</td>
</tr>
<tr>
<td style="text-align: center;">磁量子数 $m_\ell$</td>
<td style="text-align: center;">描述轨道空间伸展方向</td>
<td style="text-align: center;">决定能级中的轨道数</td>
<td style="text-align: center;">$[-\ell, +\ell]$ 的整数<br />
如 $\text{p}$ 能级有 $3$ 个方向（$x, y, z$）</td>
</tr>
<tr>
<td style="text-align: center;">自旋量子数 $m_s$</td>
<td style="text-align: center;">描述电子自旋方向</td>
<td style="text-align: center;">一个轨道最多容纳两电子</td>
<td style="text-align: center;">$+½$ ($\uparrow$) 或 $-½$ ($\downarrow$)</td>
</tr>
</tbody>
</table>
