...
\$\$ \begin{aligned} i\^0&=1\\ i\^1&=i\\ i\^2&=-1\\ i\^3&=-i\\ i^n&=i^ \end{aligned} \$\$
...
\$\$ x^n-1=(x-1)\big(x^+\cdots+1\big) \$\$}+x\^{\\n-2

只要 \$k\ne 0\$，就有 \$\xi_k\ne 1\$，这样，

\$\$ 0=\xi_k^{\\n}-1=(\xi_k-1)\big(\xi_k^+\cdots+1\big) \$\$}+\xi_k\^{\\n-2
...
\$\$ \def\cis{\operatorname{cis}} \cis^nx=e^=\cis(nx) \$\$
