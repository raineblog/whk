...
3. 补集：$U = \{1, 2, 3}, A \subseteq U$, 若 $A = \{1}$, 则 $complement\_U A = \{2, 3}$。
...
$$
\complement\_U(A\cap B)=(\complement\_UA)\cup(\complement\_UB)
$$

$$
\complement\_U(A\cup B)=(\complement\_UA)\cap(\complement\_UB)
$$

推广到多个集合中：

$$
\complement\_U(A\_1 \cap A\_2 \cap \cdots \cap A\_n) = (\complement\_U A\_1) \cup (\complement\_U A\_2) \cup \cdots \cup (\complement\_U A\_n)
$$

$$
\complement\_U(A\_1 \cup A\_2 \cup \cdots \cup A\_n) = (\complement\_U A\_1) \cap (\complement\_U A\_2) \cap \cdots \cap (\complement\_U A\_n)
$$
...
[https://web.mit.edu/sp.268/www/nim.pdf](https://web.mit.edu/sp.268/www/nim.pdf)

[https://www.cs.cmu.edu/afs/cs/academic/class/15859-s05/www/ferguson/comb.pdf](https://www.cs.cmu.edu/afs/cs/academic/class/15859-s05/www/ferguson/comb.pdf)

[http://www.maths.liv.ac.uk/\~mathsclub/talks/20220226/talk1/NIM.pdf](http://www.maths.liv.ac.uk/~mathsclub/talks/20220226/talk1/NIM.pdf)

[https://assets.hkoi.org/training2021/game-theory.pdf](https://assets.hkoi.org/training2021/game-theory.pdf)

[https://www.luogu.com.cn/article/nhpwudt7](https://www.luogu.com.cn/article/nhpwudt7)

[https://oi-wiki.org/math/game-theory/impartial-game/](https://oi-wiki.org/math/game-theory/impartial-game/)
