...
Dilworth 定理与 [Hall 婚配定理](https://raineblog-whk.pages.dev/science/mathematics/graph/graph-matching/graph-match.md#hall-%E5%AE%9A%E7%90%86) 等价。我们可以用 Dilworth 定理证明如下定理：
