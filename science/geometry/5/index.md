...
这种缩放向量并相加的思想很重要，我们称 ^,^​ 为 xy 坐标系的**基向量**。
...
[xy​]→x[ab​]+y[cd​]=x[ax+cybx+dy​]

我们通常把 a,b,c,d 这四个数封装在一个东西中，称为**矩阵**，对于上面的，

[ab​cd​]

左边一列右边一列（称为矩阵的列）分别表示变换之后的 ^,^​ 基，(a,b),(c,d)。

因此可以定义出矩阵乘向量的简化形式，

[ab​cd​][xy​]=x[ab​]+y[cd​]=[ax+cybx+dy​]

其中，左边的矩阵可以理解为一个函数，对于右边的向量操作。

根据这个，可以得出很多有意思的矩阵，

在变换的时候，可以先对 ^ 变换，再对 ^​ 变换，可以方便一点。

如果变换的 ^,^​ 是线性相关的，那么就会丢失一个维度，使张成空间成为一个直线。

注：线性的严格定义，若一个变换 L 满足，

L(v+w)=L(v)+L(w)L(cv)=cL(v)
...
[10​11​](%5B01%E2%80%8B%E2%88%9210%E2%80%8B%5D%5Bxy%E2%80%8B%5D)=[11​−10​][xy​]
...
[ac​bd​][eg​fh​]→[ac​bd​][eg​],[ac​bd​][fh​]

即，

[ac​bd​][eg​fh​]=[ae+bgce+dg​af+bhcf+dh​]
...
​adg​beh​cfi​​​xyz​​=x​adg​​+y​beh​​+z​cfi​​=​ax+by+czdx+ey+fzgx+hy+iz​​
...
=−+​det​​adg​beh​cfi​​​adet([eh​fi​])bdet([dg​fi​])cdet([dg​eh​])​
...
因此，对于一个 n×n 的矩阵，其秩最大为 n，即张成了整个 n 维空间，称为**满秩**。
...
[01​−10​]: %E9%80%86%E6%97%B6%E9%92%88%E6%97%8B%E8%BD%AC%C2%A090%E2%88%98%5B10%E2%80%8B11%E2%80%8B%5D:%E5%89%AA%E5%88%87,%E9%94%99%E5%88%87
