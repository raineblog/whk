...
![alt text](../image-26.avif#class="custom-img";float="50%")
...
![alt text](../image-27.avif#class="custom-img";float="60%")
...
![alt text](../image-12.avif#class="custom-img";float="50%")
...
![alt text](../image-13.avif#class="custom-img";float="40%")
...
![alt text](../image-14.avif#class="custom-img";float="40%")
...
![alt text](../imagett.avif#class="custom-img";float="60%")
...
![alt text](../image-24.avif#class="custom-img";float="40%")
...
![alt text](../Sinh_cosh_tanh.svg#class="custom-img";float="60%")
...
![alt text](../image-32.avif#class="custom-img";float="40%")
...
![alt text](../image-34.avif#class="custom-img")
...
- 将直线 $\ell$ 平移到与曲线相切的位置，得到曲线的一条与直线 $\ell$ 平行的切线 $\ell'$，此时直线 $\ell$ 与 $\ell'$ 之间的距离即为曲线与 $\ell$ 距离的最值。
  ...
  ![alt text](../image-35.avif#class="custom-img";float="30%")
...
![alt text](../image-38.avif#class="custom-img")
...
![alt text](../image-3.avif#class="custom-img";float="60%")
...
![alt text](../image-11.avif#class="custom-img";float="40%")
...
![alt text](../image-9.avif#class="custom-img";float="40%")
...
![alt text](../image-22.avif#class="custom-img";float="40%")
...
1.  抛物线的焦点关于任意一条切线的对称点一定在准线上。
    ...
    ![alt text](../image-16.avif#class="custom-img";float="40%")
...
2.  假设抛物线在点 $X$ 和 $Y$ 的切线相交于点 $P$。那么 $PX'=PY'=PF$，其中 $X'$ 和 $Y'$ 是 $X$ 和 $Y$ 在抛物线准线上的投影，而 $F$ 是抛物线的焦点。
    ...
    ![alt text](../image-17.avif#class="custom-img";float="90%")
...
3.  做抛物线上两点 $X,Y$ 的切线，相交于点 $P$，若 $PX\perp PY$，则 $P$ 在抛物线的准线上。反过来，过准线上一点 $P$ 做抛物线的两条切线，则他们相互垂直。同时，$XY$ 一定过焦点 $F$ 且 $PF\perp XY$。
    ...
    ![alt text](../image-18.avif#class="custom-img";float="40%")
...
4.  我们做推广，两条切线为 $\varphi$ 或 $180^\circ-\varphi$ 的点的集合是一个以 $F$ 焦点，抛物线准线 $\ell$ 为准线的双曲线，其离心率等于 $|\cos\varphi|$。
    ...
    ![alt text](../image-19.avif#class="custom-img";float="40%")
...
![alt text](../image-40.avif#class="custom-img")

![alt text](../image-45.avif#class="custom-img")

![alt text](../image-42.avif#class="custom-img")

![alt text](../image-43.avif#class="custom-img")

![alt text](../image-44.avif#class="custom-img")

![alt text](../image-41.avif#class="custom-img")

![alt text](../image-46.avif#class="custom-img")
...
![alt text](../image-2-9525fa1.avif#class="custom-img";float="80%")
