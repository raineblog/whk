...
![alt text|w50%](../Cassini-3kurv.svg)
...
![alt text|w100%](../Superellipse-3.avif)
...
![alt text](../Construction_triangle_Reuleaux[1].svg)

![alt text](../image.avif)

勒洛多边形是勒洛三角形的拓展：

![alt text|w80%](../Reinhardt_15-gons[1].svg)
...
![alt text|w50%](../reconstructed_image.svg)
