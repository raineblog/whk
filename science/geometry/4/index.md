...
`<img src="../Cassini-3kurv.svg" width="50%">`{=html}
...
`<img src="../Superellipse-3.avif" width="100%" alt="alt text">`{=html}
...
`<img src="../Construction_triangle_Reuleaux[1].svg" alt="alt text">`{=html}

`<img src="../image.avif" alt="alt text">`{=html}

勒洛多边形是勒洛三角形的拓展：

`<img src="../Reinhardt_15-gons[1].svg" width="80%" alt="alt text">`{=html}
...
`<img src="../reconstructed_image.svg" width="50%" alt="alt text">`{=html}
...
`<img src="../image-23.avif" width="85%" alt="alt text">`{=html}
