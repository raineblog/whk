...
::img\[alt text]\{src="../Construction\_triangle\_Reuleaux\[1].svg"}

::img\[alt text]\{src="../image.avif"}

勒洛多边形是勒洛三角形的拓展：

::img\[alt text]\{src="../Reinhardt\_15-gons\[1].svg" width="80%"}
...
::img\[alt text]\{src="../reconstructed\_image.svg" width="50%"}
