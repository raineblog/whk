...
可记为 \${a_i}*{i\in\mathbb N}\$ 或 \$(a_i)*\$。}\$ 或 \$\langle a_i\rangle\_{i\in\mathbb N
...
可记为 \${a_i}*{i=1}\^n\$ 或 \$(a_i)*\^n\$。}\^n\$ 或 \$\langle a_i\rangle\_{i=1
...
\$\$ \begin{aligned} a\_{n-1}\times a\_{n+1}&=aq^{n-2}aq^\\ &=a^2q^\\ &=(aq^{n-1})^2\\ &=a_n\^2 \end{aligned} \$\$
...
\$\$ \begin{aligned} S_n&=a_1+a_1q+a_1q^2+\dots+a_1q^\\ &=a_1(1+q+q^2+\dots+q^) \end{aligned} \$\$
...
\$\$ \frac{q^n}{(q^+1)(q^n+1)}=\frac{1}{q-1}\left(\frac{1}{q^n+1}-\frac{1}{q\^{n+1}+1}\right) \$\$
...
\$\$ \begin{aligned} a_n=2a\_{n-1}+1\\ 2a\_{n-1}=4a\_{n-1}+2\\ 4a\_{n=2}=8a\_{n-2}+4\\ \dots\\ 2^{n-3}a_3=2^\\ 2}a_2+2\^{n-3^{n-2}a_2=2^ \end{aligned} \$\$}a_1+2\^{n-2

上述式子相加，

\$\$ a_n=2^{n-1}a_1+2^+\dots+4+2+1 \$\$}+2\^{n-3
...
\$\$ a_1=2\cos\theta={1\over2}\\ \cos\theta={1\over4}\\ \theta=\arccos¼ \$\$
...
\$\$ a\_{n+1}=2a_n^2-1={k^=f(2x) \$\$}+k\^{-2x}\over2

令，初项，

\$\$ a_1=f(t)={k^t+k^=3 \$\$}\over2

令，

\$\$ k^t=3+2\sqrt2,k^=3-2\sqrt2 \$\$

于是，

\$\$ a_2=f(2t)={k^{2t}+k^\\ a_3=f(4t)={k}\over2^{4t}+k^\\ \dots\\ a_n=f(2}\over2^{n-1}t)={k^{2^{n-1}t}+k^{-2^{n-1}t}\over2}={(k^t)^{2^+(k}^{-t})^ \$\$}}\over2

带入，得，

\$\$ a_n={(3+2\sqrt2)^{2^+(3-2\sqrt2)}^{2^ \$\$}}\over2
...
\$\$ {a_n\over2^n}={a\_{n-1}\over2^ \$\$}}+{n\over2\^n

记 \$b_n=a_n/2\^n\$，

\$\$ b_n=b\_{n-1}+n/2\^n\\ b\_{n-1}=b\_{n-2}+(n-1)/2\^{n-1}\\ \dots\\ b_2=b_1+½\\ b_1=½ \$\$

上式相加，得，

\$\$ b_n={n\over2^n}+{n-1\over2^ \$\$}}+\dots+{1\over2}+{1\over2

注意到分母为二的幂次的形式，等式乘二，

\$\$ 2b_n={n\over2^{n-1}}+{n-1\over2^+\dots+1+1 \$\$}

下式减上式，得，

\$\$ \begin{aligned} b_n&=-{n\over2^n}+{1\over2^+{1\over2}^{n-2}}+\dots+{1\over2^1}+1\\ &={1\over2^{n-1}}\left(1+2+\dots+2^\\ &={2}\right)-{n\over2\^n^n-1\over2^-{n\over2}^n}=2-{2+n\over2^n} \end{aligned} \$\$
...
\$\$ {a_n\over2^n}={a\_{n-1}\over2^+{n}^2\over2^n} \$\$
...
\$\$ b_n={1^2\over2^1}+{2^2\over2^2}+{3^2\over2^3}+{4^2\over2^4}+\dots+{(n-1)^2\over2^+{n}^2\over2^n} \$\$

两边同时乘二，得，

\$\$ 2b_n=1+{2^2\over2^1}+{3^2\over2^2}+{4^2\over2^3}+\dots+{(n-1)^2\over2^+{n}^2\over2^ \$\$}

下式减上式，得，

\$\$ b_n=1-{n^2\over2^n}+{2^2-1^2\over2^1}+{3^2-2^2\over2^2}+{4^2-3^2\over2^3}+\dots+{(n-1)^2-(n-2)^2\over2^+{n}^2-(n-1)^2\over2\^{n-1}} \$\$
...
\$\$ \begin{aligned} c_n&={2^2-1^2\over2^1}+{3^2-2^2\over2^2}+{4^2-3^2\over2^3}+\dots+{(n-1)^2-(n-2)^2\over2^+{n}^2-(n-1)^2\over2\^{n-1}}\\ &={2\times2-1\over2^1}+{2\times3-1\over2^2}+{2\times4-1\over2^3}+\dots+{2(n-1)-1\over2^ \end{aligned} \$\$}}+{2n-1\over2\^{n-1}
...
\$\$ 2c_n=3+{2\times3-1\over2^1}+{2\times4-1\over2^2}+\dots+{2(n-1)-1\over2^{n-3}}+{2n-1\over2^\\ \$\$}

与原式相减，得，

\$\$ \begin{aligned} c_n&=3-{2n-1\over2^{n-1}}+{2\over2^1}+{2\over2^2}+\dots+{2\over2^\\ &=3-{2n-1\over2}}+{2\over2\^{n-2}^{n-1}}+{1\over2^0}+{1\over2^1}+\dots+{1\over2^\\ &=3-{2n-1\over2}}+{1\over2\^{n-3}^{n-1}}+{1\over2^(1+2+2}^2+\dots+2^)\\ &=3-{2n-1\over2^{n-1}}+{2^\\ &=5-{2n-1\over2}-1\over2\^{n-3}^{n-1}}-{1\over2^ \end{aligned} \$\$}

于是，

\$\$ b_n=1-{n^2\over2^n}+c_n=6-{n^2\over2^n}-{2n-1\over2^{n-1}}-{1\over2^ \$\$}

于是，

\$\$ a_n=2^nb_n=3\times2^-n\^2-4n-6 \$\$
