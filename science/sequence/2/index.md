...
\$\$ a_n=\lambda_1q_1^{n-1}+\lambda_2q_2^ \$\$
...
\$\$ \begin{aligned} a_n&={1+\sqrt5\over2\sqrt5}\left({1+\sqrt5\over2}\right)^{n-1}-{1-\sqrt5\over2\sqrt5}\left({1-\sqrt5\over2}\right)^\\ &={1\over\sqrt5}\left\[\left({1+\sqrt5\over2}\right)^n-\left({1-\sqrt5\over2}\right)^n\right\] \end{aligned} \$\$
...
\$\$ c\_{n+1}+1=8c_n+8=8(c_n+1)\\ c_n=8^{n-1}(c_1+1)-1=4\times8^-1 \$\$

同理，

\$\$ d\_{n+1}+7=2d_n+14=2(d_n+7)\\ d_n=2^{n-1}(d_1+7)-7=8\times2^-7 \$\$

则，

\$\$ a_n={c_n+d_n\over2}=2\times8^{n-1}+2^-4 \$\$
...
**保序性**：若两数列 \${a_n}*{n\in\mathbb N},{b_n}*\$ 分别收敛于 \$A,B\$，则，
...
\$\$ \lim\_{n\to\infty}{a_1x^{c_1}+a_2x^+\dots\over b_1x^{c_1}+b_2x^,c_1\>c_2\>\dots \$\$}+\dots}={a_1\over b_1
...
\$\$ \lim\_{n\to\infty}{2+(⅓)^n\over(⅓)^n-5}={\lim\_{n\to\infty}2+(⅓)^n\over\lim\_{n\to\infty}(⅓)^n-5}={2+\lim\_{n\to\infty}(⅓)^n\over\lim\_{n\to\infty}(⅓)^n-5}=-{2\over5} \$\$
...
\$\$ (\sqrt\[n\]2)^{n(n+1)}\>(\sqrt\[n+1\]2)^\\ 2^{n+1}\>2^n \$\$
...
\$\$ 2021^{-2^n}=(2021^{-2})^n=\left({1\over2021}\right)^{2^ \$\$}
...
\$\$ (1-x)(1+x)=1-x\^2\\ (1-x^2)(1+x^2)=1-x\^4\\ \dots\\ (1-x^{2^n})(1+x^{2^n})=1-\left(x^{2^n}\right)^2=1-x^{2^n\times2}=1-x^ \$\$}

于是，原式两边同乘 \$1-x\$，得，

\$\$ (1-x)a_n=1-x^{2^\\ a_n={1-x}^{2^ \$\$}}\over1-x

考虑极限，

\$\$ \lim\_{n\to\infty}a_n={1-\lim\_{n\to\infty}x^{2^ \$\$}}\over1-x

我们知道，

\$\$ n\to\infty\Rightarrow2\^{n+1}\to\infty\Rightarrow x^{2^\to0,\because\|x\|\<1 \$\$}
...
\$\$ a_n={(⅔)^{n-1}-4\over(⅔)^={2}-2^{n-1}-4\cdot3^\over2^{n-1}-2\cdot3^ \$\$}
...
\$\$ a_n-2={1\over n-⅔}={3\over3n-2}\\ a_n={3\over3n-2}+2={6n-1\over3n-2} \$\$
...
\$\$ a_1=2\\ a_2=½\\ a_3=-1\\ a_4=2 \$\$

为 \$T=3\$ 的周期数列，因此，

\$\$ a_n=\left{\begin{aligned} 2&\quad\operatorname{if}n\equiv1\pmod3\\ ½&\quad\operatorname{if}n\equiv2\pmod3\\ -1&\quad\operatorname{if}n\equiv0\pmod3\\ \end{aligned}\right. \$\$
...
\$\$ a_n-\sqrt2=(\sqrt2-1)^{n-1}(a_1-\sqrt2)=(2-\sqrt2)(\sqrt2-1)^\\ a_n=\sqrt2(\sqrt2-1)\^n+\sqrt2 \$\$
...
\$\$ b_n+\sqrt2=xb_n-\sqrt2x\\ (x-1)b_n=\sqrt2(x+1)\\ b_n=\sqrt2{x+1\over x-1}=\sqrt2{(\sqrt2+1)^{2n-1}+(\sqrt2-1)^\over(\sqrt2+1)^{2n-1}-(\sqrt2-1)^ \$\$}

考虑进一步化简，此时有两个形式，

\$\$ b_n=\sqrt2{(\sqrt2+1)^{4n-2}+1\over(\sqrt2+1)^=\sqrt2{1+(\sqrt2-1)}-1^{4n-2}\over1-(\sqrt2-1)^ \$\$}
...
\$\$ 1\<{1+(\sqrt2-1)^{4n-2}\over1-(\sqrt2-1)^+1 \$\$}}\le(\sqrt2-1)\^{4n-3

左侧显然，右侧，移项，

\$\$ {2(\sqrt2-1)^{4n-2}\over1-(\sqrt2-1)^\\ {2(\sqrt2-1)\over1-(\sqrt2-1)\^{4n-2}}\le1\\ 2(\sqrt2-1)\le1-(\sqrt2-1)\^{4n-2}\\ (\sqrt2-1)}}\le(\sqrt2-1)\^{4n-3^{4n-2}\le3-2\sqrt2=(\sqrt2-1)^2\\ 4n-2\ge2,n\ge1 \$\$
...
\$\$ \boxed{{1\over1-\alpha}\left\[{1\over(n+1)\^{\alpha-1}}-{1\over n\^{\alpha-1}}\right\]\<{1\over n\^\alpha}\<{1\over1-\alpha}\left\[{1\over n^{\alpha-1}}-{1\over(n-1)^,n\ge2 \$\$}}\right\]

例如，

\$\$ \begin{aligned} \alpha=½&\longrightarrow\boxed{2(\sqrt{n+1}-\sqrt n)\<\sqrt n\<2(\sqrt n-\sqrt{n-1})}\\ \alpha=⅓&\longrightarrow\boxed{{3\over2}\left(\sqrt\[3\]{(n+1)^2}-\sqrt\[3\]{n^2}\right)\<{1\over\sqrt\[3\]n}\<{3\over2}\left(\sqrt\[3\]{n^2}-\sqrt\[3\]{(n-1)^2}\right)} \end{aligned} \$\$
...
\$\$ a_1=1,a_2=¼\\ a\_{n+1}={(n-1)a_n\over n-a_n} \$\$
...
\$\$ S_n=\sum\_{i=1}^nk_i=n+\sum\_{i=1}^n2^i=n+2^-2 \$\$
...
\$\$ \begin{aligned} \sum\_{i=2}^{2020}(-1)^i(4i-1)-(4\times2021-1)&=4\times2-1+\sum\_{i=2}^{2020}(-1)^\[4(i+1)-1\]\\ \sum\_{i=2}^{2020}(-1)^i(4i-1)-8083&=7+\sum\_{i=2}^{2020}(-1)^(4i+3)\\ &=7-\sum\_{i=2}^{2020}(-1)^i(4i-1+4)\\ &=7-\sum\_{i=2}^{2020}(-1)^i(4i-1)-\sum\_{i=2}^{2020}(-1)^i4\\ &=7-\sum\_{i=2}^{2020}(-1)^i(4i-1)-4 \end{aligned} \$\$
...
\$\$ \begin{aligned} a\_{2k-2}&=-2a\_{2k-1}-{1\over2\^{2k-1}}+1\\ &=-{1\over2^{2k-1}}+2-{1\over2^+1\\ &=-{1\over2\^{2k-2}}+3\\ a\_{2k}&=-{1\over2\^{2k}}+3 \end{aligned} \$\$}
