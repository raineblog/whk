...
$$
H\_n=\ln n+\gamma+\mathcal O\left(\{1\over n}\right)
$$

同时，

$$
\sum\_\{i=1}^nH\_i=(n+1)H\_n-n
$$

$$
\sum\_\{i=1}^niH\_i=\{n(n+1)\over2}H\_n-\{n(n-1)\over4}
$$

$$
\sum\_\{i=1}^n\{i\choose m}H\_i=\{n+1\choose m+1}\left(H\_\{n+1}-\{1\over m+1}\right)
$$
...
$$
\det A=\sum\_\{\pi\in S\_n}\operatorname\{sgn}(\pi)\prod\_\{i=1}^na\_\{i,\pi(i)}
$$
