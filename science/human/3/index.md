...
- 血浆中约 [\$90\\\$]{.arithmatex} 为水；其余 [\$10\\\$]{.arithmatex} 分别是：蛋白质（[\$7\\ \sim 9\\\$]{.arithmatex}），无机盐（约 [\$1\\\$]{.arithmatex}），以及血液运输的其他物质，包括各种营养物质（如葡萄糖）、激素、各种代谢废物等。
...
- **渗透压**是指溶液中溶质微粒对水的吸引力。
  ...
  在组成细胞外液的各种无机盐离子中，含量上占有明显优势的是 [\$\ce{Na+}\$]{.arithmatex} 和 [\$\ce{Cl-}\$]{.arithmatex}。细胞外液渗透压的 [\$90\\\$]{.arithmatex} 以上来源于 [\$\ce{Na+}\$]{.arithmatex} 和 [\$\ce{Cl-}\$]{.arithmatex}。在 [\$\pu{37\^oC}\$]{.arithmatex} 时。人的血浆渗透压约为 [\$\pu{770 kPa}\$]{.arithmatex}，相当于细胞内液的渗透压。

  我们将会在水盐平衡部分详细讨论渗透压的稳态。

- 正常人的血浆近中性，pH 为 [\$7.35 \sim 7.45\$]{.arithmatex}。血浆的 pH 之所以能够保持稳定，与其中含有的 [\$\ce{HCO3-,H2CO3}\$]{.arithmatex} 等物质有关。

  模拟生物体维持 pH 的稳定：在溶液中加入酸或碱，缓冲对（如 [\$\ce{HPO4\^2- / H2PO4-}\$]{.arithmatex}）能使溶液 pH 的变化减弱；与自来水相比，生物组织匀浆更类似于缓冲液。

  ![alt text](../image-4.avif){width="60%"}

  人体内环境中也有很多缓冲对，其中最重要的是 [\$\ce{HCO3- / H2CO3}\$]{.arithmatex}，其次还有 [\$\ce{HPO4\^2- / H2PO4-}\$]{.arithmatex} 等。当一定量的酸性或碱性物质进入后，内环境的 pH 仍能维持在一定范围内。

- 人体细胞外液的温度一般维持在 [\$\pu{37\^oC}\$]{.arithmatex} 左右（此处的体温是一个总的概念，并不是通过测量皮肤的温度就可以得出的体温）。

  正常情况下，不同人的体温，会因年龄、性别等的不同而存在微小差异；同一个人的体温在一日内也有变化，但变化幅度一般不超过 [\$\pu{1\^oC}\$]{.arithmatex}。尽管气温波动范围较大，但健康人的体温始终接近 [\$\pu{37\^oC}\$]{.arithmatex}。
...
除激素外，其他一些化学物质，如组胺、某些气体分子（[\$\ce{NO}\$]{.arithmatex}、[\$\ce{CO}\$]{.arithmatex} 等）以及一些代谢产物（如 [\$\ce{CO2}\$]{.arithmatex}），也能作为体液因子对细胞、组织和器官的功能起调节作用。[\$\ce{CO2}\$]{.arithmatex} 是调节呼吸运动的重要体液因子。体液中 [\$\ce{CO2}\$]{.arithmatex} 浓度变化会刺激相关感受器，从而通过神经系统对呼吸运动进行调节。临床上给患者输入 [\$\ce{O2}\$]{.arithmatex} 时，往往采用含有 [\$5\\\$]{.arithmatex} 左右的 [\$\ce{CO2}\$]{.arithmatex} 的混合气体，以达到刺激呼吸中枢的目的。
...
- 图中黄色部分：胰岛 B 细胞（[\$\beta\$]{.arithmatex} 细胞），分泌胰岛素。

- 图中绿色部分：胰岛 A 细胞（[\$\alpha\$]{.arithmatex} 细胞），分泌胰高血糖素。

- 图中紫色部分：胰岛 D 细胞（[\$\delta\$]{.arithmatex} 细胞），分泌生长抑素。
...
4.  抗炎与免疫抑制作用：这是糖皮质激素在临床药理上最主要的应用领域。
    ...
    - **通路与机制：**
      ...
      2.  **抑制转录因子NF-κB**：直接结合并抑制 NF-κB，从而阻断多种促炎细胞因子（如TNF-[\$\alpha\$]{.arithmatex}, IL-1, IL-6, IL-8）的基因转录。
...
5.  心血管系统调节
    ...
    - **通路与机制：**
      1.  **允许作用：**糖皮质激素本身不直接收缩血管，但它能增加血管平滑肌对儿茶酚胺（肾上腺素、去甲肾上腺素）的敏感性（上调 [\$\alpha1\$]{.arithmatex} 受体表达）。如果缺乏GC，血管对升压药会失去反应。
...
- 钠离子 [\$\ce{Na+}\$]{.arithmatex} 的主要来源是食盐，几乎全部由小肠吸收，主要经肾随尿排出，排出量几乎等于摄入量。

- 钾离子 [\$\ce{K+}\$]{.arithmatex} 不仅在维持细胞内液的渗透压上起决定性作用，而且还具有维持心肌舒张、保持心肌正常兴奋等重要作用。
...
- 炎炎夏季，在高温环境中从事体力劳动的人，最容易发生中暑。中暑是指高温引起机体体温调节功能紊乱所表现出的一系列症状，如高热、皮肤干燥、恶心、呕吐、食欲不振、心悸、头痛等。严重中暑会使体温超过 [\$\pu{40\^oC}\$]{.arithmatex}，病死率比较高。
