...
![alt text](../细胞外液.avif#class="custom-img";float=50%"
...
- 作用于靶器官、靶细胞：众多的激素分子弥散在全身的体液中，甲状腺激素几乎对全身的细胞都起作用，而促甲状腺激素只作用于甲状腺。能被特定激素作用的器官、细胞，就是该激素的靶器官、靶细胞。激素选择靶细胞，是通过与靶细胞上的特异性受体相互识别，并发生特异性结合实现的。
  ...
  ![alt text](../image-14.avif#class="custom-img";float=60%"
...
![alt text](../image-19.avif#class="custom-img";float=90%"
...
![alt text](../raineblog.dpdns.org_whk_science_human_3_.avif#class="custom-img"
...
![alt text](../image-12.avif#class="custom-img";float=40%"
...
![alt text](../image-21.avif#class="custom-img";float=60%"
...
![alt text](../%E6%97%A0%E6%A0%87%E9%A2%98-2025-09-14-2104.svg#class="custom-img";float=80%"

血糖平衡的调节，也就是调节血糖的来源和去向，使其处于平衡状态。

![alt text](../raineblog.dpdns.org_whk_science_human_3_%281%29.avif#class="custom-img"
...
![alt text](../image-20.avif#class="custom-img";align="right";float=40%"
