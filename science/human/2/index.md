...
| Na^+ | 降低     | 几乎无直接影响       | **降低**（动作电位难以产生） |
| Na^+ | 升高     | 几乎无直接影响       | 理论上轻微升高               |
...
- **动作电位的产生与传导**：当膜电位达到“阈电位”时，触发爆发性的动作电位。这一电信号沿着肌细胞膜（及 T 管系统）迅速传导。
...
- **膜学说（Membrane Theory）：**
  - 由朱利叶斯·伯恩斯坦（Julius Bernstein）在 1902 年提出。他认为细胞膜在静息时只对 K^+ 有通透性，而**兴奋是由于细胞膜瞬间变得对所有离子都通透**，导致电位差消失（降为 0）。虽然现在的“超射”现象（电位变正）证明了其局限性，但这奠定了现代电生理学的基础。
...
| **決定性離子**   | **鉀離子 (K^+)** 的外流               | 上升支主要靠 **鈉 (Na^+) 或 鈣 (Ca^{2+})** 內流 下降支主要靠 **鉀 (K^+)** 外流 |
