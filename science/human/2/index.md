...
![alt text](../image.avif#class="custom-img";align="right";float=35%"
...
![alt text](../image-1.avif#class="custom-img";float=40%"
...
![alt text](../image-11.avif#class="custom-img";float=80%"
...
![alt text](../image-9.avif#class="custom-img";float=80%"
...
- 触发动作电位的刺激需要达到一定强度和时间，称为阈值，高中阶段更多考虑阈强度。
  ...
  ![alt text](../image-10.avif#class="custom-img";float=40%"
