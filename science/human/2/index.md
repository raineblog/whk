...
`<img src="../image.avif" align="right" width="35%" alt="alt text">`{=html}
...
`<img src="../image-1.avif" width="40%" alt="alt text">`{=html}
...
`<img src="../image-11.avif" width="80%" alt="alt text">`{=html}
...
`<img src="../image-9.avif" width="80%" alt="alt text">`{=html}
...
- 触发动作电位的刺激需要达到一定强度和时间，称为阈值，高中阶段更多考虑阈强度。
  ...
  `<img src="../image-10.avif" width="40%" alt="alt text">`{=html}
