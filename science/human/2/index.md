...
![alt text](/static/image/image.e41d712532.avif){align="right" width="35%"}
...
![alt text](/static/image/image-1.2c8b2d0453.avif){width="40%"}
...
![alt text](/static/image/image-11.71c76b7ec7.avif){width="80%"}
...
![alt text](/static/image/image-9.6b5e11dc3b.avif){width="80%"}
...
![alt text](/static/image/image-3.817327f264.avif){width="100%"}
更详细的极化过程描述：
...
- 触发动作电位的刺激需要达到一定强度和时间，称为阈值，高中阶段更多考虑阈强度。
  ...
  <img alt="alt text" src={image7} />\{width="40%"}
...
![alt text](/static/image/image-8.1d4d9733a0.avif){width="100%"}
|    影响因素   | 影响的电位及其结果 |
| :-------: | :-------: |
| 体外钠离子浓度增加 |   动作电位升高  |
| 体外钠离子浓度减小 |   动作电位下降  |
...
![alt text](/static/image/image-2.c9fd8d2731.avif){width="100%"}
...
- **兴奋-收缩耦联的三大假说（针对电信号如何变成收缩）：**
  ...
  - **化学耦联假说：** 曾有人假设某种化学物质（如肌醇三磷酸 $IP\_3$）作为中介。现在已知 $IP\_3$ 在平滑肌和部分信号传导中起重要作用，但在快速的骨骼肌兴奋中不是主导。
...
- **去極化 (Depolarization) - 上升支：**
  ...
  - _注：在心肌和平滑肌中，鈣離子 ($Ca^\{2+}$) 的內流也起重要作用。_
...
<td style="text-align: left;"><strong>鉀離子 ()</strong> 的外流</td>
<td style="text-align: left;">上升支主要靠 <strong>鈉 () 或 鈣 ()</strong> 內流<br />
下降支主要靠 <strong>鉀 ()</strong> 外流</td>
</tr>
<tr>
