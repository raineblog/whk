...
- **T 淋巴细胞**（简称 T 细胞，因在胸腺 **T**hymus 中发育成熟而得名 T）：T 细胞是一个庞大的家族，它们可以说是免疫应答中最重要的组成部分。
  ...
  - **辅助性 T 细胞**（Helper T Cells，简称 Th 细胞）：它们是免疫系统的"总司令"。
    ...
    <img alt="alt text" src={image0} />\{width="60%"}
...
![alt text](/static/image/image-22.f612828ab6.avif){width="100%"}
...
- 吞噬细胞：通常是体内具有吞噬功能的一群细胞称。
  ...
  - 单核细胞与**巨噬细胞**：巨噬细胞由血液中的单核吞噬细胞进入组织后分化而来，几乎分布于机体的各种组织中。它们被称为"清道夫"，吞噬病原体、细胞碎片和死亡细胞，它还可以分泌细胞因子。
    ...
    <img alt="alt text" src={image3} />\{width="70%"}
...
![alt text](/static/image/image-25.42da4c99ae.avif){width="70%"}
...
![alt text](/static/image/antibody_chart_recreated-895e7c5.b26b539582.avif){width="70%"}
...
- 免疫防御：机体排除外来抗原性异物的一种免疫防护作用，这是免疫系统最基本的功能。
  ...
  <img alt="alt text" src={image6} />\{width="90%"}
...
![alt text](/static/image/image-28.a1a9f0b33d.avif){width="70%"}
...
![](/static/image/image-26.4a110e5b40.avif){width="50%"}
...
- 另一类是由疾病和其他因素引起的，叫作**获得性免疫缺陷病**，如艾滋病。大多数免疫缺陷病都属于获得性免疫缺陷病。
  ...
  <img alt="alt text" src={image9} />\{width="80%"}
  ...
  <img alt="alt text" src={image10} />\{width="70%"}
...
1. ::: \{#fn:note1}
   参考：[https://www.organtranspl.com/cn/article/pdf/preview/10.3969/j.issn.1674-7445.2012.01.013.pdf](https://www.organtranspl.com/cn/article/pdf/preview/10.3969/j.issn.1674-7445.2012.01.013.pdf)。 [↩](#fnref:note1 "Jump back to footnote 1 in the text")\{.footnote-backref}
   :::
   :::
