...
- 羟基酸缩聚：
  ...
  <img src={image5} />\{width="60%"}

  <img src={image6} />\{width="80%"}

- 醇酸缩聚：

  <img src={image7} />\{width="70%"}
...
![alt text](/static/image/image-38.3d650c7eac.avif){width="60%"}
二元羧酸成环：

![alt text](/static/image/image-39.4556d842c1.avif){width="80%"}
氨基酸成环：

![alt text](/static/image/image-40.f159ea0ece.avif){width="60%"}
## 官能团的转化 \{#\_13}
