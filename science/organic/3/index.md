...
![alt text](/static/image/image-4.46295c20df.avif)
### 二元取代计数 \{#\_7}

确定链状烷烃**二取代物**的同分异构体数目时，可首先固定一个取代基，再按照顺序移动另一个取代基以确定同分异构体数目，下面以确定 $ce\{CH3CH2CH3}$ 的二氯代物的数目为例

![alt text](/static/image/image-5.0fcb493bc6.avif){width="50%"}
...
![](/static/image/碎片法1.6b36bb2fa0.avif)
![](/static/image/碎片法2.96637ed565.avif)
### 马氏规则概述 \{#\_9}
...
![alt text](/static/image/image.966205b506.avif){width="30%"}
...
![alt text](/static/image/image-1.9f272887de.avif){width="30%"}
...
![alt text](/static/image/image-3.97feeabb63.avif){width="30%"}
...
- 亲水基越多越易溶于水，憎水剂越多、越大越难溶于水。
  ...
  - 憎水基：烃基（$ce\{-C\_nH\_\{2n+1}}$，$ce\{-CH=CH2}$，$ce\{-C6H5}$），卤素（$ce\{-X}$），硝基（$ce\{-NO2}$），酯基（$ce\{-COO-}$）。
