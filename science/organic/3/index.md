...
::img\[alt text]\{src="../image-5.avif" width="50%"}
...
::img\[alt text]\{src="../image.avif" width="30%"}
...
::img\[alt text]\{src="../image-1.avif" width="30%"}

1. 碳化钙是电石的主要成分，反应后可能有 $\ce\{H2S},\ce\{PH3}$ 等杂志，可用 $\ce\{CuSO4}$ 溶液除去。

   ::img\[alt text]\{src="../image-13.avif"}
...
::img\[alt text]\{src="../image-3.avif" width="30%"}
