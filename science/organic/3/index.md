...
- **顺反异构**：原子或原子团在碳碳双键上的位置不同。
  ...
  >
  > `<img src="../2.12.avif" width="70%">`{=html}
  >
...
- **对映异构**：互为镜像且不能重叠的结构，即存在手性碳原子便存在对映异构。
  ...
  >
  > `<img src="../2.13.svg" width="60%">`{=html}
...
`<img src="../image-5.avif" width="50%" alt="alt text">`{=html}
...
`<img src="../碎片法1.avif">`{=html}

`<img src="../碎片法2.avif">`{=html}
...
`<img src="../image.avif" width="30%" alt="alt text">`{=html}
...
`<img src="../image-1.avif" width="30%" alt="alt text">`{=html}

1.  碳化钙是电石的主要成分，反应后可能有 $\ce{H2S},\ce{PH3}$ 等杂志，可用 $\ce{CuSO4}$ 溶液除去。

    `<img src="../image-13.avif" alt="alt text">`{=html}
...
`<img src="../image-3.avif" width="30%" alt="alt text">`{=html}
