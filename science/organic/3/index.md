...
- **顺反异构**：原子或原子团在碳碳双键上的位置不同。
  ...
  >
  > ![alt text](../2.12.avif#class="custom-img";float=70%"
  >
...
- **对映异构**：互为镜像且不能重叠的结构，即存在手性碳原子便存在对映异构。
  ...
  >
  > ![alt text](../2.13.svg#class="custom-img";float=60%"
...
![alt text](../image-5.avif#class="custom-img";float=50%"
...
![alt text](../碎片法1.avif#class="custom-img"

![alt text](../碎片法2.avif#class="custom-img"
...
![alt text](../image.avif#class="custom-img";float=30%"
...
![alt text](../image-1.avif#class="custom-img";float=30%"

1.  碳化钙是电石的主要成分，反应后可能有 $\ce{H2S},\ce{PH3}$ 等杂志，可用 $\ce{CuSO4}$ 溶液除去。

    ![alt text](../image-13.avif#class="custom-img"
...
![alt text](../image-3.avif#class="custom-img";float=30%"
