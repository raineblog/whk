...
碳原子在有机物中，通常与四个原子直接相连，即配位数为 [\$4\$]{.arithmatex}，与一个碳原子相连的原子既可以是碳原子、也可以是其他原子，碳原子的这种独特的成键能力，是有机化合物多样性的根本原因。
...
碳原子间的共价键可以是：单键（[\$\ce{C - C}\$]{.arithmatex}）、双键（[\$\ce{C = C}\$]{.arithmatex}）、三键（[\$\ce{C \# C}\$]{.arithmatex}）。
...
[\$\Omega=\$]{.arithmatex} 重键数 [\$+\$]{.arithmatex} 最简环数

也就是说，一个不饱和度，也就是少了一对氢原子，例如，[\$\ce{C=C}\$]{.arithmatex} 不饱和度为 [\$1\$]{.arithmatex}，[\$\ce{C#C}\$]{.arithmatex} 为 [\$2\$]{.arithmatex}。

同时，不饱和度 [\$\Omega\$]{.arithmatex} 也可以通过分子式求出：

::: {.arithmatex}
\$\$ \begin{aligned} \Omega(\ce{C_xH_y})&=\dfrac{(2x+2)-y}{2}\\ \Omega(\ce{C_xH_ySi_aX_m})&=\dfrac{2(x+a)+2-(y+m)}{2}\\ \Omega(\ce{C_xH_yO_qS_p})&=\dfrac{(2x+2)-y}{2}\\ \Omega(\ce{C_xH_yN_b})&=\dfrac{2(x+b)+2-(y+b)}{2}\\&=\dfrac{2x+2-y+b}{2} \end{aligned} \$\$
:::

- 卤素原子 [\$\ce{X}\$]{.arithmatex} 视为氢原子、硅视为碳原子。

- [\$\ce{C-O}\$]{.arithmatex} 和 [\$\ce{C=O}\$]{.arithmatex} 不影响不饱和度，硫也是。

- 一个苯环 [\$=\$]{.arithmatex} 三个双键一个环，不饱和度为 [\$4\$]{.arithmatex}。
...
|  | 表示方式 | 示例 |
|:--:|----|:--:|
| 分子式 | 用元素符号表示物质的分子组成 | [\$\ce{CH4}\$]{.arithmatex} |
| 最简式（实验式） | 用元素符号表示化合物中各元素原子个数的最简整数比 | [\$\ce{CH2O}\$]{.arithmatex} |
| 电子式 | 在元素符号周围用「[\$\cdot\$]{.arithmatex}」或「[\$\times\$]{.arithmatex}」表示原子的最外层电子的成键情况 | ![](../CCl4.avif){width="200"} |
| 结构式 | 用短线「[\$\ce{-}\$]{.arithmatex}」来表示 1 个共价键，将所有原子连接起来 | ![](../2.3.svg){width="200"} |
| 结构简式 | 省略结构式中的单键「[\$\ce{-}\$]{.arithmatex}」，将与碳原子相连的其他原子写在其旁边，在右下角注明其个数 | [\$\ce{CH3CH = CH2}\$]{.arithmatex} |
| 键线式 | 省略结构简式中与碳原子直接相连的氢原子，每个拐点或端点均表示一个碳原子，不足的用氢原子补足 | ![](../Ethanol-1.avif){width="200"} |
| 球棍模型 | 小球表示原子，短棍表示化学键 | ![](../Ethanol-2.avif){width="200"} |
| 空间填充模型 | 用不同体积的小球表示不同大小的原子，相对大小关系应与原子实际相对大小关系一致 | ![](../Ethanol-3.avif){width="200"} |
...
同系物：结构相似，在分子组成上相差一个或若干个 [\$\ce{CH2}\$]{.arithmatex} 原子团的化合物互称为同系物。烷烃就是一个同系物系列。

|     类别     | 通式                                            |
|:------------:|-------------------------------------------------|
|    链烷烃    | [\$\ce{C_n H\_{2n+2} (n \ge 1)}\$]{.arithmatex} |
|    单烯烃    | [\$\ce{C_n H\_{2n} (n \ge 2)}\$]{.arithmatex}   |
|    环烷烃    | [\$\ce{C_n H\_{2n} (n \ge 3)}\$]{.arithmatex}   |
|     炔烃     | [\$\ce{C_n H\_{2n-2} (n \ge 2)}\$]{.arithmatex} |
|    二烯烃    | [\$\ce{C_n H\_{2n-2} (n \ge 4)}\$]{.arithmatex} |
| 苯及其同系物 | [\$\ce{C_n H\_{2n-6} (n \ge 6)}\$]{.arithmatex} |
...
|:--:|:--:|:--:|:--:|:--:|:--:|
| 烯烃 | 碳碳双键 | [\$\ce{C=C}\$]{.arithmatex} | 炔烃 | 碳碳三键 | [\$\ce{C#C}\$]{.arithmatex} |
| 卤代烃 | 碳卤键 | [\$\ce{-X}\$]{.arithmatex} | 醇/酚 | 醇羟基/酚羟基 | [\$\ce{-OH}\$]{.arithmatex} |
| 醚 | 醚键 | [\$\ce{-O-}\$]{.arithmatex} | 胺 | 氨基 | [\$\ce{-NH2}\$]{.arithmatex} |
| 醛 | 醛基 | [\$\ce{-CHO}\$]{.arithmatex} | 酮 | 酮羰基 | [\$\ce{-CO-}\$]{.arithmatex} |
| 羧酸 | 羧基 | [\$\ce{-COOH}\$]{.arithmatex} | 酯 | 酯基 | [\$\ce{-COOR}\$]{.arithmatex} |
| 酰胺/酰卤 | 酰胺/酰卤基 | [\$\ce{-CONH2/-COX}\$]{.arithmatex} | 腈 | 氰基 | [\$\ce{-CN}\$]{.arithmatex} |
...
2.  定编号：
    ...
    以阿拉伯数字表示取代基或官能团的位置编号，以中文数字表示取代基个数，阿拉伯数字与汉字间以短横线「[\$-\$]{.arithmatex}」分开。
...
![alt text](../%E7%BB%93%E6%9E%84.svg){width="100%"}
...
1.  **母体官能团定为 [\$1\$]{.arithmatex} 号位：** 例如在"甲苯"中，甲基所在的碳自动定为 [\$1\$]{.arithmatex} 号，不需要写\"1-甲基\...\"。
2.  **其余取代基位次最小：** 从 [\$1\$]{.arithmatex} 号位开始，向其余取代基最近的方向编号。
...
现代化的元素分析仪可以测出有机物含有元素，例如 [\$\ce{C,H,O}\$]{.arithmatex} 的质量比，可以根据这个推算出为止有机物的实验式（最简式）。

有机物完全燃烧的规律：

- 燃烧热：则每个碳原子对燃烧热的贡献大约是 [\$\pu{400kJ/mol}\$]{.arithmatex}，每个氢原子对燃烧热的贡献大约是 [\$\pu{150kJ/mol}\$]{.arithmatex}。也就是说近似的：

  ::: {.arithmatex}
  \$\$ Q(\ce{C_xH_y})\approx 400x+150y \$\$
  :::

  假设产物水为液态，这个公式对于碳数小于 [\$20\$]{.arithmatex} 的烷烃是较为准确的，对于烯烃、炔烃、芳香烃等就误差较大了。
...
- 耗氧量：实际上上面的燃烧热的近似公式，也是可以用耗氧量来估算的，有一个经验规律是，烃的燃烧热与其完全燃烧的耗氧量，非常接近一个线性关系。我们不妨先写出燃烧的方程式：
  ...
  对于等物质的量的有机物，[\$\paren{x+\dfrac{y}{4}}\$]{.arithmatex} 的值越大，耗氧量越多、燃烧热越大；对于等质量的有机物，[\$y/x\$]{.arithmatex} 的值越大，耗氧量越多，燃烧热越大。
...
金刚烷，分子式 [\$\ce{C10H16}\$]{.arithmatex}，它的碳架结构相当于金刚石晶格网络中的一个晶胞，故得名金刚烷。它是一种脂环烃，具有类似樟脑的气味，是无色晶体，容易结晶，其衍生物可以用作药物。
...
::: {.grid}
![](../image-34.avif){width="20%"}[\$\ce{+ H2O -\>}\quad\$]{.arithmatex}

![](../image-35.avif){width="30%"}
:::
