...
| 电子式 | 在元素符号周围用「$cdot$」或「$times$」表示原子的最外层电子的成键情况 | ![](./CCl4.avif){width="200"} |
...
| `<nowrap>`{=html}空间填充模型`</nowrap>`{=html} | 用不同体积的小球表示不同大小的原子，相对大小关系应与原子实际相对大小关系一致 | ![](./Ethanol-3.avif){width="200"} |
...
![](./image-34.avif){width="20%"}$ce{+ H2O ->}\quad$
