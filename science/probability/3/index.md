...
![alt text](../Zufall.avif#class="custom-img"
...
![alt text](../image-07dd56b.avif#class="custom-img";float=60%"
...
![Normal distribution curve that illustrates standard deviations. Each band has 1 standard deviation, and the labels indicate the approximate proportion of area (note: these add up to 99.8%, and not 100% because of rounding for presentation.)](../Standard_deviation_diagram.svg#class="custom-img"
