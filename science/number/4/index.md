...
$$
\def\arraystretch\{1.1} \begin\{array}\{ll} a=q\_1m+r\_1,&0\le r\_1\<m\ b=q\_2m+r\_2,&0\le r\_2\<m\ \end\{array}
$$
...
则一定存在 $i\neq j$ 使得 $ax\_i\equiv ax\_j\pmod m$。

因为 $a \perp m$，因此有 $x\_i\equiv x\_j\pmod m$。

与 $x\_1,\dots,x\_m$ 为模 $m$ 的完全剩余系不符。
...
$$
\def\arraystretch\{1.1} \begin\{array}\{rcl} (a,b)+\[a,b]+a+b&=\&ab\ d+a\_0b\_0d+a\_0d+b\_0d&=\&a\_0b\_0d^2\ a\_0b\_0+a\_0+b\_0+1&=\&a\_0b\_0d \end\{array}
$$

因为 $a\_0b\_0\ge a\_0b\_0,a\_0,b\_0\ge1$，所以 $0\<d\le4$。

当 $d=1$ 时，$a\_0+b\_0+1=0$，无解。

当 $d=2$ 时，

$$
\def\arraystretch\{1.1} \begin\{array}\{rcl} a\_0b\_0+a\_0+b\_0+1&=&2a\_0b\_0\ a\_0b\_0-a\_0-b\_0&=&1\ a\_0(b\_0-1)-(b\_0-1)&=&2\ (a\_0-1)(b\_0-1)&=&2\ \end\{array}
$$

- $a\_0-1=1$，$b\_0-1=2$；$a\_0=2$，$b\_2=3$；$a=4$，$b=6$。
- $a\_0-1=2$，$b\_0-1=1$；$a\_0=3$，$b\_2=2$；$a=6$，$b=4$。

当 $d=3$ 时，

$$
\def\arraystretch\{1.1} \begin\{array}\{rcl} a\_0b\_0+a\_0+b\_0+1&=&3a\_0b\_0\ 2a\_0b\_0-a\_0-b\_0&=&1\ 4a\_0b\_0-2a\_0-2b\_0&=&2\ 2a\_0(2b\_0-1)-(2b\_0-1)&=&3\ (2a\_0-1)(2b\_0-1)&=&3\ \end\{array}
$$

- $2a\_0-1=1$，$2b\_0-1=3$；$a\_0=1$，$b\_2=2$；$a=3$，$b=6$。
- $2a\_0-1=3$，$2b\_0-1=1$；$a\_0=2$，$b\_2=1$；$a=6$，$b=3$。

当 $d=4$ 时，

$$
\def\arraystretch\{1.1} \begin\{array}\{rcl} a\_0b\_0+a\_0+b\_0+1&=&4a\_0b\_0\ 3a\_0b\_0-a\_0-b\_0&=&1\ 9a\_0b\_0-3a\_0-3b\_0&=&3\ 3a\_0(3b\_0-1)-(3b\_0-1)&=&4\ (3a\_0-1)(3b\_0-1)&=&4\ \end\{array}
$$

- $3a\_0-1=2$，$3b\_0-1=2$；$a\_0=b\_0=1$；$a=b=4$。
- $2a\_0-1=1$，$2b\_0-1=4$；不存在整数解。
- $2a\_0-1=4$，$2b\_0-1=1$；不存在整数解。
