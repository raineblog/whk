...
- 求 \$(2x+y)*{\mathrm{min}}\$：\$x*=3a\$}=a \implies y\_{\min}=a \implies (2x+y)\_{\mathrm{min}

- 求 \$(2x+y)*{\mathrm{max}}\$：\$\begin{cases}x-y\leq 0 \\ x+y\leq 2\end{cases}\xRightarrow{\mathrm{Add }} x\leq 1\implies y\leq 1\implies (2x+y)*=3\$}
