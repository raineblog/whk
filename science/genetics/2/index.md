...
- 患甲病概率 *n*，患乙病概率 *m*。
- 同时患两病概率 *n\*\*m*，不患病概率 (1 − *n*)(1 − *m*)。
- 患病概率 *n* + *m* − *n\*\*m*，患一种病概率 *n* + *m* − 2*n\*\*m*。
- 只患甲病概率 *n*(1 − *m*) = *n* − *n\*\*m*，只患乙病概率 *m*(1 − *n*) = *m* − *n\*\*m*。
...
- 例如 AAa 染色体的配子产生为：``` (``A``A``, ``` ``` a``)``; ``` ``` (``A``a``, ``` ``` A``)``; ``` ``` (``A``a``, ``` ``` A``) ```，即 $\\rm{AA:Aa:A:a}=1:2:2:1$。
...
``` (``A``_``b``b``)``; ``` ``` (``A``_``B``_``, ``` ``` a``a``B``_``, ``` ``` a``a``b``b``) ```
...
``` (``A``_``B``_``, ``` ``` a``a``B``_``)``; ``` ``` (``A``_``b``b``)``; ``` ``` (``a``a``b``b``) ```
...
``` (``A``_``B``_``, ``` ``` a``a``b``b``)``; ``` ``` (``A``_``b``b``, ``` ``` a``a``B``_``) ```
