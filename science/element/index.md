...
- 置换反应可以用通式 A+BC→AC+B 表示。所有置换反应都属于氧化还原反应，因为必有单质参与，化合价一定发生变化。
...
置换反应的本质是**单质与化合物反应，生成另一种单质和另一种化合物**，符合 A+BC→AC+B 的通式。所有置换反应都属于氧化还原反应。以下按照被置换元素的类型分类。

#### 涉及稀有气体的置换

稀有气体极难发生反应，但较重的稀有气体（如 \\ceKr、\\ceXe）能形成氟化物和氧化物。在这些反应中，稀有气体通常作为“被置换“的元素出现，因为它们的化合物具有极强的氧化性和氟化能力。
...
以上五大类十二小类基本覆盖了常见的置换反应。只要满足“单质 + 化合物 → 单质 + 化合物“的形式，就可以从周期表中选取相应元素，写出大量的置换反应方程式。
