...
- 置换反应可以用通式 *A* + *B\*\*C* → *A\*\*C* + *B* 表示。所有置换反应都属于氧化还原反应，因为必有单质参与，化合价一定发生变化。
...
置换反应的本质是**单质与化合物反应，生成另一种单质和另一种化合物**，符合 *A* + *B\*\*C* → *A\*\*C* + *B* 的通式。所有置换反应都属于氧化还原反应。以下按照被置换元素的类型分类。
