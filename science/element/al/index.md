...
![alt text](/static/image/image.24235c521b.avif){width="80%"}
### 铝的工业制取 \{#\_5}

常见的工业制铝为霍尔-埃鲁法，现在常与与拜耳法联用，产铝量大。

![](/static/image/Bayer_process-chinese_annotation.f04d9b5d3c.avif){width="70%"}
1. 粉碎：
...
![铝三角](/static/image/铝三角.afccdd96d9.avif){width="60%"}
|  编号 |                     反应方程式                     |
| :-: | :-------------------------------------------: |
