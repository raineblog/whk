...
常见的含硫矿石：黄铁矿（$ce\{FeS2}$）、黄铜矿（$ce\{FeCuS2}$）、辰砂朱砂（$ce\{HgS}$）、雄黄（$ce\{As4S4}$）、雌黄（$ce\{As2S3}$）、芒硝（$ce\{Na2SO&#x34;_&#x31;0H2O}$）、生石膏（$ce\{2CaSO&#x34;_&#x48;2O}$）、熟石膏（$ce\{CaSO4\*2H2O}$）。
...
- 还原性：
  ...
  - $ce\{X\_2 + SO2 + 2H2O -> 2HX + H2SO4}$（$ce\{X = Cl2 / Br2 / I2}$）。
