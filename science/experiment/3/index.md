...
1. **海水淡化**：
   ...
   - **离子交换法**：用树脂除去阴阳离子。
     ...
     > 注意：必须**先通过阳离子交换树脂，再通过阴离子交换树脂**。若顺序相反，\\ce{OH-} 会与海水中的金属离子形成沉淀堵塞树脂。
1. **环境保护**：
   - **酸雨**：\\pH \\le 5.6。成因是 \\ce{SO2} 和 \\ce{NO_x}。
     - 硫酸型：\\ce{SO2 -> H2SO3 -> H2SO4}。
     - 硝酸型：\\ce{NO -> NO2 -> HNO3}。
     - 防治：燃煤脱硫（\\ce{CaO + SO2 + O2 -> CaSO4}）、汽车尾气净化。
   - **水体富营养化**：氮、磷含量过高，导致“水华”或“赤潮”。

海带提碘和海水提溴是最经典的富集实验，海带自带富集碘的作用，海带中碘含量是海水的 10^4 倍作用；海水中也有不少的溴。

海带提碘的主要步骤是，灼烧干海带，用氯气氧化，萃取和反萃取；海水提溴的主要步骤是，用氯气氧化，热空气吹出溴单质。在这里要注意的两点是，海带提碘不能用蒸馏获得碘，因为四氯化碳和碘是共沸物，难以蒸馏分离；海水提溴需和二氧化硫混合再次氧化吹出，以进一步富集。
...
海水提溴，通常和粗盐及其提纯放在一起，将海水浓缩结晶得到的粗盐，依次加入氢氧化钠、氯化钡、碳酸钠、盐酸，加热蒸干即可得到精盐，饱和食盐水电解即可得到氢氧化钠、氯气和氢气，这称为氯碱工业。

将精盐水（饱和食盐水）依次通入二氧化碳和氨气，经过一系列处理得到碳酸氢钠，加热分解得到碳酸钠，剩余的再次通入氨气，加入氯化钠，得到饱和氯化钠溶液，即可得到氯化铵固体和新的饱和食盐水重复利用，这就是侯氏制碱法。

将粗盐提纯后得到的剩余液体，这称为母液，其本质上还是浓盐水，只不过其中的镁离子、溴离子浓度就比较高了，我们向其中加入足量石灰乳，即可得到氢氧化镁固体，用稀盐酸溶解，在氯化氢氛围中蒸干，然后电解熔融的氯化镁，即可得到镁单质，这就是海水提镁。

向母液中通入氯气，然后用热空气吹出得到含有溴单质（液态溴易挥发）的空气，与二氧化硫混合通入水中，得到富含溴离子和硫酸根的水，然后继续用氯气氧化、热空气吹出，就可以得到富含溴单质的蒸汽，冷却后即可得到液态溴，这就是海水提溴。
...
1. **农药**：波尔多液（\\ce{CuSO4} \\cdot \\ce{Ca(OH)2}）。
...
1. **粉碎**：增加接触面积，加快速率。
1. **温控**：防止物质分解（如 \\ce{H2O2}）或水解。
1. **气保护**：通入惰性气体（如 \\ce{N2}）防止氧化或排除装置内空气。
...
概念：由于人类活动的影响，氮、磷 等营养物质含量过高导致的水质恶化现象现象：水华、赤潮等
...
高考工业流程题通常以真实工业生产为背景，考察元素的性质、转化及分离提纯。
