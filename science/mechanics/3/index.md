...
受力分析，得 *G\*\*x* = *m\*\*g*sin *θ*，*f* = *μ**m**g*cos *θ*。
...
推广：如果两个物体两侧分别拉着（*F*1 拉质量为 *m*1 的物体，*F*2 对于 *m*2）：
...
**例题3**：质量为 2kg 的物体静止于水平面的 *A* 处，*A\*\*B* 间距 *L* = 20m，如图：
...
形式一：拉着下面的 *M* 走，其上表面 *μ*1、下表面 *μ*2：

*F* = (*m* + *M*)(*μ*1 + *μ*2 + tan *θ*)*g* ⋅ cos *θ*

若斜面是水平面（*θ* = 0），那么 cos *θ* = 1, tan *θ* = 0：

*F* = (*m* + *M*)(*μ*1 + *μ*2)*g*

形式二：拉着上面的 *m* 走，其下 *M* 上表面 *μ*1、下表面 *μ*2：
