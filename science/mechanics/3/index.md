...
`<img src="../mnt847j0.avif" alt="直角劈模型">`{=html}
...
`<img src="../image-2.avif" align="right" width="50%" alt="alt text">`{=html}
...
`<img src="../最速降线.avif" width="100%">`{=html}

伯努利（哥哥和弟弟分别）证明了最速降线是一条摆线。

## 传送带和板块模型 {#_10}

`<img src="../方法总结.avif" width="90%">`{=html}
