...
![alt text](/static/image/image-1.703131021a.avif){width="60%"}
...
其中 $theta$ 表示力与位移的夹角，$x\_F$ 表示在力 $F$ 的方向上的位移。
...
![模型](/static/image/动能定理九个模型.50919a2c95.avif){width="90%"}
1. 圆周运动上受力和速度的关系。
