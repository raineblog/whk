...
多物体牛二：在 F=ma 中，左侧 F 表示合外力，右侧等号应为 ma 的矢量和即可，证明略。
...
v(t)=Δt→0lim​Δtx(t+Δt)−x(t)​=dtdx​a(t)=Δt→0lim​Δtv(t+Δt)−v(t)​=dtdv​=dt2d2x​
...
设参考系 S′ 相对于惯性参考系 S 以不变的加速度 a0​ 运动。
...
其中 F惯​=−ma0​，称为惯性力，可以理解为受到与加速度方向相反的大小为 ma0​ 的力。
...
这个原理推广了惯性系中的情况。比如，一个关在正自由落体的电梯中的观察者，会发现只要不知道电梯外的情况，自己就是个有效的惯性系，即使此时他正受引力作用加速下落（注：当然此时的 g=g0​−a，其中 g0​ 表示原来的重力加速度，a 表示加速下落的加速度）。
...
其中 θ 表示力与位移的夹角，xF​ 表示在力 F 的方向上的位移。

一般来说（对于简单题），直线运动用 W=Fxcosθ，曲线运动用 W=FxF​。

做功正负：正负号取决于 cosθ 的大小，即
...
机械能是指宏观物质所表现出的势能 Ep​ 与动能 Ek​ 的总和，即：
...
W合​WG​+Wf​+…​=ΔEk​=21​mvt​2−21​mv0​2​
...
杆子和绳子这种同步转动的，关联速度 v=rω（同一物体 ω 相同）。
