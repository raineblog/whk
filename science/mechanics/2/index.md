...
\$\$ v(t) =\lim\_{\Delta{t}\to0}\dfrac{x(t+\Delta{t})-x(t)}{\Delta{t}} =\dfrac{\mathrm{d}x}{\mathrm{d}t} \\1.2em\] a(t) =\lim\_{\Delta{t}\to0}\dfrac{v(t+\Delta{t})-v(t)}{\Delta{t}} =\dfrac{\mathrm{d}v}{\mathrm{d}t} =\dfrac{\mathrm{d^2}x}{\mathrm{d}t^ \$\$}
...
\$\$ m\bm{a}\'=\bm{F}-m\bm{a}*0=\bm{F}+\bm{F}* \$\$
