...
在角动量中，我们也可以把 v 和 sinα 放在一起，得到卫星的质量与其速度在垂直于中心天体连线分量的乘积为一个定值，根据这个可以推出一些结论。

质点 O 在某一时刻受到力 F 的左右，我们取平面内一点 O，记位失 r=OA。我们将力 F 分解为平行于 r 的分量 Fr​ 与垂直于其的分量 F⊥​，我们知道 Fr​ 对角动量是没有作用的，而 F⊥​ 则改变物体的角动量：
