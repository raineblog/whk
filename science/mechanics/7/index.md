...
我们知道，绕太阳运动的行星有速度 **v** 与位失 **r**。

由开普勒第二定律，我们可以推出：

*r\*\*v*sin *α* = const.

其中 *α* 是 **v**, **r** 夹角，两边同时乘以质量，这个物理量称为角动量（标量式）。
...
当质点做圆周运动时，夹角恒为直角，那么 *J* = *m**r**v*。

当质点做直线运动，对于直线外一点到这个质点作为位失，依然是有角动量的。

### 角动量定理

在角动量中，我们也可以把 **v** 和 sin *α* 放在一起，得到卫星的质量与其速度在垂直于中心天体连线分量的乘积为一个定值，根据这个可以推出一些结论。

质点 *O* 在某一时刻受到力 *F* 的左右，我们取平面内一点 *O*，记位失 $\\bm r=\\overrightarrow{OA}$。我们将力 *F* 分解为平行于 **r** 的分量 *F\*\*r* 与垂直于其的分量 *F*⟂，我们知道 *F\*\*r* 对角动量是没有作用的，而 *F*⟂ 则改变物体的角动量：
