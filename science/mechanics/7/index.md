...
质点 $O$ 在某一时刻受到力 $F$ 的左右，我们取平面内一点 $O$，记位失 $bm r=\overrightarrow\{OA}$。我们将力 $F$ 分解为平行于 $bm r$ 的分量 $F\_r$ 与垂直于其的分量 $F\_\perp$，我们知道 $F\_r$ 对角动量是没有作用的，而 $F\_\perp$ 则改变物体的角动量：
