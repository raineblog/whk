...
![alt text|w90%](/static/image/Chloralkali_membrane.e9d7ec3a0b.avif)
...
阳极上阴离子放电：还原性顺序，活泼电极 $>\ce\{S^2}>\ce\{SO\_3^2-}>\ce\{I-}>$ $\ce\{Br-}>\ce\{Cl-}>\ce\{OH-}>$ 含氧酸根 $>\ce\{F-}$。
...
![alt text|right|w30%](/static/svg/Standard_hydrogen_electrode_2009-02-06.373df17982.svg)
$$
\ce\{2H+(aq) + 2e- -> H2(g)}
$$
...
设 $E\_\{cell}^\{o}$ 为电池的标准电位，可由阳极和阴极的标准电极电位计算而来：
