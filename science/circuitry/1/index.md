...
设 $E_S$ 为电源电动势，$R_S$ 为内阻，$R$ 为负载，$V_0$ 为施加电压，$I$
为电流：
...
设 $I_S$ 为电源电流，$G_S$ 为内部电导，$G$ 为负载电导，$V_0$
为施加电压，$I$ 为电流：
...
如果 $G\ll G_S$，则
$I_S\doteq I$。因此，输出电压会因负载波动而发生较大变化。
...
![alt text|right|w30%](../image-14.avif)
...
![alt text|right|w30%](../image-15.avif)
