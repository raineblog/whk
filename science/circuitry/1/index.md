...
::: {.grid}
![alt text](../image-7.avif)

![alt text](../image-8.avif)
:::
...
![alt text](../image-14.avif){align="right" width="30%"}
...
1.  ::: {#fn:note100}
    <https://zh.wikipedia.org/wiki/欧姆定律#常見錯誤>。 [↩](#fnref:note100 "Jump back to footnote 1 in the text"){.footnote-backref}
    :::
:::
