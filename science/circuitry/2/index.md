...
- 开关 \$K_2\$ 倒向标准电源的一边与 \$\varepsilon_0\$ 连通检流计发生偏转，移动触点 C，使检流计中的电流 \$I_g=0\$，这时有 \$\varepsilon_0=U\_{[AC]{.abbr title="Alternating Current (交流电)"}}\$。

- 同理，\$K_2\$ 倒向待测电源一侧时，做相应的调节，使检流计回到零位，则有 \$\varepsilon_x = U\_{[AC]{.abbr title="Alternating Current (交流电)"}\'}\$。
