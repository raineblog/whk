...
![alt text](../滑动变阻器.drawio.avif#class="custom-img";float="90%")
...
![alt text](../image-37.avif#class="custom-img";float="30%")

### 欧姆表 {#_5}

一个常见的欧姆表电路图如左图所示：

![alt text](../image-12.avif#class="custom-img")
...
![alt text](../image-9.avif#class="custom-img")

  
![alt text](../image-10.avif#class="custom-img")
...
![alt text](../IP.avif#class="custom-img";float="50%")

电灯泡 $U-I$ 与电源 $U-I$ 联立：

- 根据短路电流 $I=E/r$ 得出横截距，以 $E$ 为纵截距在 $U-I$ 图上做出下降直线（电源）。

  ![alt text](../UI.avif#class="custom-img";float="50%")
...
![alt text](../image-26.avif#class="custom-img";float="80%")
...
![alt text](../image-27.avif#class="custom-img";float="80%")
...
![alt text](../image-28.avif#class="custom-img";float="40%")
...
![alt text](../image-29.avif#class="custom-img";float="40%")
...
![alt text](../image-30.avif#class="custom-img";float="40%")
...
![alt text](../image-2.avif#class="custom-img";float="90%")

![alt text](../image-3.avif#class="custom-img";float="90%")
...
![alt text](../image-31.avif#class="custom-img";float="60%")
...
![alt text](../电源测量.svg#class="custom-img";float="50%")
...
![alt text](../image-32.avif#class="custom-img";float="60%")
...
![alt text](../image-13.avif#class="custom-img";float="50%")
...
![alt text](../image-34.avif#class="custom-img";align="right";float="40%")
...
![alt text](../image-36.avif#class="custom-img";float="85%")
...
![alt text](../image-38.avif#class="custom-img";float="70%")

![alt text](../image-39.avif#class="custom-img";float="90%")
