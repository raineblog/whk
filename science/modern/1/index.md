...
![alt text](../image-5-313d0d9.avif#class="custom-img";float=80%"
...
这就是充气问题的基本方程。如果充入的是大气（$p_0 = p_{\text{atm}}$，$T_0 = T_{\text{环境}}$），则只需确定充入气体的体积 $V_0$ 即可。
...
例如，一个钢瓶装有压强为 $p_0$ 的气体，每次放出气体的物质的量为 $\Delta n$（在标准状态下体积为 $V_{\text{std}}$），共放 $n$ 次，求最终压强。
...
![alt text](../image.png#class="custom-img";float=100%"
