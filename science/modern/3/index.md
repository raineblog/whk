...
![alt text](../image-c6b859b.avif#class="custom-img";float=80%"
...
![alt text](../image_2ae7a8c.svg#class="custom-img";float=40%"
...
![alt text](../image_a673292.svg#class="custom-img";float=75%"

![alt text](../Diffuse_reflection1_0d7ce0d.svg#class="custom-img"
...
![alt text](../Cornerreflector_b0ec3b2.svg#class="custom-img";float=40%"
...
![alt text](../image-19.avif#class="custom-img";float=80%"
...
![alt text](../image-20.avif#class="custom-img";float=80%"

![alt text](../Prism-rainbow.svg#class="custom-img";float=80%"

如果一束光从一种介质射入另一种介质，我们称折射率较小的为光疏介质，折射率较大的为光密介质。存在一个临界角 $\theta_c$ 使得入射角大于这个角，则不会发生折射现象，所有关系全部向内面反射，称为**全反射**或全内反射。

![alt text](../RefractionReflextion-zh.svg#class="custom-img";float=100%"
...
![alt text](../image-22.avif#class="custom-img";float=90%"

![alt text](../image-23.avif#class="custom-img";float=90%"
...
3.  把长方形玻璃砖放在白纸上，并使其长边与 $aa'$ 重合，再用直尺画出玻璃的另一边 $bb'$。
    ...
    ![alt text](../image.avif#class="custom-img";align="right";float=40%"
...
![alt text](../Optical_fiber_types_8399934-5168fcc.avif#class="custom-img";float=100%"
...
- 海市蜃楼与沙漠蜃景：折射与全反射。
  ...
  ![alt text](../Mirage_principle.svg#class="custom-img";float=60%"

- 水井中多青蛙看天：洞口更小、视野更大。

  ![alt text](../image-21.avif#class="custom-img";float=50%"
...
- 岸上的人看鱼：**人看到的鱼偏浅**。
  ...
  ![alt text](../Pencil_in_a_bowl_of_water.svg#class="custom-img"
...
![alt text](../Optical_flat_interference.svg#class="custom-img";float=80%"
...
![alt text](../image-8.avif#class="custom-img";float=60%"
...
![alt text](../image-2.avif#class="custom-img";float=40%"
...
![alt text](../7f497ec15f6c0d1f_e77bd7e.svg#class="custom-img";float=60%"
...
![衍射光栅示意图](../image-3.avif#class="custom-img";float=80%"
...
![机械波的偏振](../image-5.avif#class="custom-img";float=100%"
...
![偏振片原理](../image-6.avif#class="custom-img";float=80%"
...
![偏振镜的效果](../image-7.avif#class="custom-img";float=60%"
...
![alt text](../image-3-d4e31b1.avif#class="custom-img"

![alt text](../image-4-8076e3a.avif#class="custom-img"
