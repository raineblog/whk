...
![alt text|w100%](/static/image/image-18.20f0223629.avif)
...
![alt text|w80%](/static/image/image-c6b859b.b41f141704.avif)
...
![alt text|w40%](/static/svg/image_2ae7a8c.df6d68dcba.svg)
...
![alt text|w80%](/static/image/image-19.a3b7eff066.avif)
...
3. 把长方形玻璃砖放在白纸上，并使其长边与 $aa'$ 重合，再用直尺画出玻璃的另一边 $bb'$。
   ...
   <img alt="alt text|right|w40%" src={image12} />
...
![alt text|w100%](/static/image/Optical_fiber_types_8399934-5168fcc.07c62faee3.avif)
...
- 海市蜃楼与沙漠蜃景：折射与全反射。
  ...
  <img alt="alt text|w60%" src={image14} />

- 水井中多青蛙看天：洞口更小、视野更大。

  <img alt="alt text|w50%" src={image15} />
...
![alt text|w60%](/static/image/image-1.1044faaaac.avif)
...
![alt text|w80%](/static/svg/Optical_flat_interference.4ea1dcc63e.svg)
...
![alt text|w60%](/static/image/image-8.88bdb97b9b.avif)
...
![alt text|w40%](/static/image/image-2.40586f0945.avif)
...
![alt text|w60%](/static/svg/7f497ec15f6c0d1f_e77bd7e.a7343ac41b.svg)
...
![衍射光栅示意图|w80%](/static/image/image-3.34fec8d330.avif)
> **科学史话：泊松亮斑**
>
...
![机械波的偏振|w100%](/static/image/image-5.8aca8bb20a.avif)
### 光的偏振现象
...
![偏振片原理|w80%](/static/image/image-6.b823c90ecd.avif)
### 自然光与偏振光
...
![偏振镜的效果|w60%](/static/image/image-7.2c65e8b655.avif)
> **科学漫步：立体电影和偏振光**
>
