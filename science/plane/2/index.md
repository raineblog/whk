...
我们记 $theta$ 是从 $x$ 旋转到 $OP$ 的角度，$r$ 是 $OP$ 长度。
...
指定一角 $theta$，点 $1,0$ 旋转 $theta$ 度得到的点 $A(x,y$，那么：
...
![三角函数](/static/image/tri-sin-cos-tan.a317322b3b.avif){width="100%"}
### 周期性 \{#\_16}
