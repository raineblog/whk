...
1. 正弦函数：
1. 中心对称：((k\\pi,0),k\\in\\mathbb Z)；
1. 轴对称：(x=k\\pi-\\pi/2,k\\in\\mathbb Z)；
1. 余弦函数：
1. 中心对称：((k\\pi-\\pi/2),k\\in\\mathbb Z)；
1. 轴对称：(x=k\\pi,k\\in\\mathbb Z)。
1. 对称中心：零点；对称轴：极值点。

### 单调性

1. 正弦函数：
1. 单调递增：([2k\\pi-\\pi/2,2k\\pi+\\pi/2],k\\in\\mathbb Z)；
1. 单调递减：([2k\\pi+\\pi/2,2k\\pi+3\\pi/2],k\\in\\mathbb Z)；
1. 余弦函数：
1. 单调递增：([2k\\pi-\\pi,2k\\pi],k\\in\\mathbb Z)；
1. 单调递减：([2k\\pi,2k\\pi+\\pi],k\\in\\mathbb Z)；
