...
|:--:|:--:|:--:|:--:|:--:|
| \$0\^\circ\$ | \$0\$ | \$0\$ | \$1\$ | \$0\$ |
| \$30\^\circ\$ | \$\pi/6\$ | \$½\$ | \$\sqrt3/2\$ | \$\sqrt3/3\$ |
| \$45\^\circ\$ | \$\pi/4\$ | \$\sqrt2/2\$ | \$\sqrt2/2\$ | \$1\$ |
| \$60\^\circ\$ | \$\pi/3\$ | \$\sqrt3/2\$ | \$½\$ | \$\sqrt3\$ |
| \$90\^\circ\$ | \$\pi/2\$ | \$1\$ | \$0\$ | 无意义 |
| \$120\^\circ\$ | \$2\pi/3\$ | \$\sqrt3/2\$ | \$-½\$ | \$-\sqrt3\$ |
| \$135\^\circ\$ | \$3\pi/4\$ | \$\sqrt2/2\$ | \$-\sqrt2/2\$ | \$-1\$ |
| \$150\^\circ\$ | \$5\pi/6\$ | \$½\$ | \$-\sqrt3/2\$ | \$-\sqrt3/3\$ |
| \$180\^\circ\$ | \$\pi\$ | \$0\$ | \$-1\$ | \$0\$ |
| \$210\^\circ\$ | \$7\pi/6\$ | \$-½\$ | \$-\sqrt3/2\$ | \$\sqrt3/3\$ |
| \$225\^\circ\$ | \$5\pi/4\$ | \$-\sqrt2/2\$ | \$-\sqrt2/2\$ | \$1\$ |
| \$240\^\circ\$ | \$4\pi/3\$ | \$-\sqrt3/2\$ | \$-½\$ | \$\sqrt3\$ |
| \$270\^\circ\$ | \$3\pi/2\$ | \$-1\$ | \$0\$ | 无意义 |
| \$300\^\circ\$ | \$5\pi/3\$ | \$-\sqrt3/2\$ | \$½\$ | \$-\sqrt3\$​ |
| \$315\^\circ\$ | \$7/4\$ | \$-\sqrt2/2\$ | \$\sqrt2/2\$ | \$-1\$ |
| \$330\^\circ\$ | \$11\pi/6\$ | \$-½\$ | \$\sqrt3/2\$ | \$-\sqrt3/3\$ |
| \$360\^\circ\$ | \$2\pi\$ | \$0\$ | \$1\$ | \$0\$ |
...
\$\$ \begin{aligned} \sin0\^\circ&=0\\ \sin30\^\circ&=½\\ \sin90\^\circ&=1 \end{aligned} \$\$
...
\$\$ \begin{aligned} T\_{0}(x) & = 1\\ T\_{1}(x) & = x\\ T\_{2}(x) & = 2x\^{2}-1\\ T\_{3}(x) & = 4x\^{3}-3x\\ T\_{4}(x) & = 8x^{4}-8x^+1\\ T\_{5}(x) & = 16x^{5}-20x^+5x\\ T\_{6}(x) & = 32x^{6}-48x^-1\\ T\_{7}(x) & = 64x}+18x\^{2^{7}-112x^-7x\\ T\_{8}(x) & = 128x}+56x\^{3^{8}-256x^+160x^{4}-32x^+1\\ T\_{9}(x) & = 256x^{9}-576x^+432x^{5}-120x^+9x \end{aligned} \$\$
