...
\$\$ \def\degree{\^\circ} \begin{aligned} S&=\cos A+\cos B+\cos C\\ &=\cos A+\cos C+½\\ &=\cos(120\degree-C)+\cos C+½\\ &=-{1\over2}\cos C+{\sqrt3\over2}\sin C+\cos C+{1\over2}\\ &={\sqrt3\over2}\sin C+{1\over2}\cos C+{1\over2}\\ &=\sin C\cos30\degree+\cos C\sin30\degree +½\\ &=\sin(C+30\degree)+½ \end{aligned} \$\$
...
\$\$ \begin{cases} \sin A=3\sin B\\ c=\sqrt5\\ \cos C=⅚ \end{cases} \$\$
...
\$\$ \sin B\sin2A=\sin A\sin B\\ \sin A=\sin2A\\ \sin A=2\sin A\cos A\\ \cos A=½ \$\$
