...
即 *A*, *B* 中有一个钝角，即 △*A**B**C* 为钝角三角形。

## 例题十一

在 △*A**B**C* 中，三边长分别为 *a*, *a* + 2, *a* + 4，最小角余弦值为 13/14。
...
36 = *a*2 = *b*2 + *c*2 − 2*b\*\*c*cos *A* = *b*2 + *c*2 + *b\*\*c* ≥ 3*b\*\*c*
...
即 △*A**B**C* 为等腰三角形或直角三角形。

## 例题十四

若 △*A**B**C* 中，∠*C* 为钝角，且其面积，
...
sin2*A* − sin2*B* − sin2*C* = sin *B*sin *C*
...
因为 $c=\\sqrt3b$，这是一个 30∘, 30∘, 120∘ 的等腰三角形，
