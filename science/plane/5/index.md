...
- 在 \$\triangle ABC\$ 中，若 \$M\$ 是 \$BC\$ 的中点，则 \$\overrightarrow{AB} \cdot \overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}} = \|\overrightarrow{AM}\|\^2 - \dfrac{1}{4}\|\overrightarrow{BC}\|\^2\$。

在 \$\triangle ABC\$ 中，对于共起点的数量积 \$\overrightarrow{AB} \cdot \overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}}\$ 的求解问题，我们首先想到的是找出 \$BC\$ 的中点 \$M\$，则

\$\$ \overrightarrow{AM} = \dfrac{1}{2}(\overrightarrow{AB} + \overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}}) \$\$

所以

\$\$ \overrightarrow{AB} \cdot \overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}} = \left\[\dfrac{1}{2}(\overrightarrow{AB} + \overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}})\right\]\^2 - \dfrac{1}{4}\|\overrightarrow{BC}\|\^2 \$\$

化简整理便可得到如下结论：在 \$\triangle ABC\$ 中，

\$\$ 2\overrightarrow{AB} \cdot \overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}} = \|\overrightarrow{AB}\|\^2 + \|\overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}}\|\^2 - \|\overrightarrow{BC}\|\^2 \$\$
...
\$\$ \overrightarrow{AB} \cdot \overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}} = \dfrac{\|\overrightarrow{AB}\|\^2 + \|\overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}}\|\^2 - \|\overrightarrow{BC}\|\^2}{2} \$\$

那么在 \$\triangle ACD\$ 中，则向量余弦式可得

\$\$ \overrightarrow{AD} \cdot \overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}} = \dfrac{\|\overrightarrow{AD}\|\^2 + \|\overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}}\|\^2 - \|\overrightarrow{[DC]{.abbr title="Direct Current (直流电)"}}\|\^2}{2} \$\$

两式相减可得

\$\$ \overrightarrow{AD} \cdot \overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}} - \overrightarrow{AB} \cdot \overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}} = \dfrac{\|\overrightarrow{AD}\|\^2 + \|\overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}}\|\^2 - \|\overrightarrow{[DC]{.abbr title="Direct Current (直流电)"}}\|\^2}{2} - \dfrac{\|\overrightarrow{AB}\|\^2 + \|\overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}}\|\^2 - \|\overrightarrow{BC}\|\^2}{2} \$\$

整理后可得

\$\$ \overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}} \cdot \overrightarrow{BD} = \dfrac{\|\overrightarrow{AD}\|\^2 + \|\overrightarrow{BC}\|\^2 - \|\overrightarrow{AB}\|\^2 - \|\overrightarrow{CD}\|\^2}{2} \$\$
...
\$\$ \vecc{AD}=\dfrac12\vecc{AB}+\dfrac12\vecc{[AC]{.abbr title="Alternating Current (交流电)"}} \$\$
...
\$\$ \vecc{AI}=\lambda\left(\dfrac{\vecc{AB}}{\|\vecc{AB}}+\dfrac{\vecc{[AC]{.abbr title="Alternating Current (交流电)"}}}{\|\vecc{[AC]{.abbr title="Alternating Current (交流电)"}}\|}\right) \$\$
...
\$\$ \vecc{HA}\cdot{BC}=\vecc{HB}\cdot\vecc{[AC]{.abbr title="Alternating Current (交流电)"}}=\vecc{HC}\cdot\vecc{AB}=0 \$\$
...
\$\$ AM^2+BM^2={1\over2}([AC]{.abbr title="Alternating Current (交流电)"}^2+AB^2) \$\$
...
\$\$ \overrightarrow{AM}={1\over2}\overrightarrow{AB}+{1\over2}\overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}}\\0.5em\] \overrightarrow{BM}={1\over2}\overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}}-{1\over2}\overrightarrow{AB} \$\$

则，

\$\$ \|\overrightarrow{AM}\|^2+\|\overrightarrow{BM}\|^2={1\over2}\|\overrightarrow{AB}\|^2+{1\over2}\|\overrightarrow{[AC]{.abbr title="Alternating Current (交流电)"}}\|^2 \$\$
...
\$\$ {BM\over CM}={AB\sin\angle BAM\over [AC]{.abbr title="Alternating Current (交流电)"}\sin\angle CAM} \$\$

证明，左右两边等面积法：

\$\$ {BM\over CM}={S\_{\triangle ABM}\over S\_{\triangle ACM}}={AB\cdot AM\sin\angle BAM\over [AC]{.abbr title="Alternating Current (交流电)"}\cdot AM\sin\angle CAM}={AB\sin\angle BAM\over [AC]{.abbr title="Alternating Current (交流电)"}\sin\angle CAM} \$\$

或正弦定理：

\$\$ {BM\over\sin\angle BAM}={AB\over\sin\angle AMB}\\0.5em\] {CM\over\sin\angle CAM}={[AC]{.abbr title="Alternating Current (交流电)"}\over\sin\angle AMC} \$\$
...
\$\$ {BM\over CM}={AB\over [AC]{.abbr title="Alternating Current (交流电)"}} \$\$

是分角定理的直接推论。

### 角平分线长定理 {#_26}

\$\$ \begin{aligned} AD&=\sqrt{AB\cdot [AC]{.abbr title="Alternating Current (交流电)"}-BD\cdot CD}\\ &=\sqrt{bc\left(1-{a^2\over(b+c)^2}\right)}\\ &={2bc\over b+c}\cos{A\over2} \end{aligned} \$\$
...
\$\$ [AC]{.abbr title="Alternating Current (交流电)"}\^2=BC\cdot CD \$\$

### 斯图尔特定理 {#_29}

又译斯台沃特定理，在 \$\triangle ABC\$ 边 \$BC\$ 上任意一点 \$D\$，

\$\$ AB\^2\cdot CD+[AC]{.abbr title="Alternating Current (交流电)"}\^2\cdot BD-AD\^2\cdot BC=BD\cdot CD\cdot BC \$\$

可以由两次余弦定理推导得出。

### 平行四边形恒等式 {#_30}

\$\$ AB^2+BC^2+CD^2+AD^2=[AC]{.abbr title="Alternating Current (交流电)"}^2+BD^2 \$\$

对于一般的四边形，等式不成立，但是有不等式：

\$\$ AB^2+BC^2+CD^2+AD^2\ge [AC]{.abbr title="Alternating Current (交流电)"}^2+BD^2 \$\$

或者设 \$x\$ 表示两条对角线中点所连线段的长度：

\$\$ AB^2+BC^2+CD^2+AD^2=[AC]{.abbr title="Alternating Current (交流电)"}^2+BD^2+4x\^2 \$\$
...
一直线与 \$\triangle ABC\$ 的三边 \$AB,BC,[AC]{.abbr title="Alternating Current (交流电)"}\$ 或他们的延长线分别交于 \$X,Y,Z\$ 三点，则：
