...
描述的是电荷 q 从 A 移动到 B，做功大小与 φA​−φB​ 的关系。

WAB​=UAB​q

推导：

WAB​=−ΔEp​=EpA​−EpB​=φA​q−φB​q=UAB​q
...
- 其中 εr​ 表示相对介电常数，定义为：
  ...
  用 ε0​ 表示真空电容率，ε 表示电介质的电容率。

  ε0​≈8.854 187 817⋯×10−12(A2s4kg−1m−3) or (F/m)
...
注意：根据 U=Ed 求解时，一定要注意这个式子是无法确定正负号，即 UAB​=−EdBA​ 是成立的。因此我们可以将下标按照电场线的方向书写，即电场线从 A 到 B 就列 AB 的式子，这样可以避免正负号的问题。
...
x=21​at2=2⋅md⋅2U0​qqU⋅L2⋅m​=4U0​dUL2​
