...
描述的是电荷 $q$ 从 $A$ 移动到 $B$，做功大小与 $varphi\_A-\varphi\_B$ 的关系。
...
$$
W\_\{AB}=-\Delta E\_p=E\_\{pA}-E\_\{pB}=\varphi\_Aq-\varphi\_Bq=U\_\{AB}q
$$
...
注意：因为这里的 $theta$ 是夹角，因此请注意此时公式是不能确定正负号的，即：
...
|   电势 $varphi$   |      伏特     |    电场中单位电荷所带电势能   |      $varphi=\dfrac\{E\_p}q$     |
|     电势差 $U$     |      伏特     |     电场中两点电势的差值    | $U\_\{AB}=\varphi\_A-\varphi\_B$ |
...
- 轨迹线和电场线重合：电场线为直线，且 $v\_0$ 与 $F$ 共线。
...
![非匀强电场](/static/image/2025-01-19-18-09-56.dc9d8b4e4f.avif){align="right" width="50%"}
- 因为本身性质和重力类似，因此可以得出很多运动学动力学的结论，尤其是曲线运动。

- 有时不可忽略带电物体自身的重力，此时通常将重力和电场力做矢量和，即等效重力。

- 在动力学部分，通常列水平竖直的 $v\_t=v\_0+at$，因为需要两个方向的时间联系。
...
电容：表示电容器储存电荷的能力。用 $C$ 表示，单位为 $text F$ 法拉。
...
![alt text](/static/image/fimage-7.3000d7e53c.avif){width="100%"}
...
$$
E\_e=\dfrac12QU=\dfrac12 CU^2=\dfrac\{\varepsilon S}\{8\pi k}E^2d
$$

引入电场能量密度：

$$
\omega\_e=\dfrac\{E\_e}\{Sd}=\dfrac\{\varepsilon}\{8\pi k}E^2
$$

### 电容的决定式 \{#\_11}

$$
C=\{\varepsilon\_rS\over4\pi kd}
$$

- 其中 $varepsilon\_r$ 表示相对介电常数，定义为：

  $$
  \varepsilon\_r=\{\varepsilon\over\varepsilon\_0}=\{C\over C\_0}
  $$

  用 $varepsilon\_0$ 表示真空电容率，$varepsilon$ 表示电介质的电容率。

  $$
  \varepsilon\_0\approx8.854\ 187\ 817\dots\times10^\{-12}\mathrm\{(A^2s^4kg^\{-1}m^\{-3})\ or\ (F/m)}
  $$
...
![alt text](/static/image/fimage-8.e56de60670.avif){width="80%"}
电容器并联：
...
$$
\dfrac\{1}\{C}=\dfrac\{1}\{C\_1}+\dfrac\{1}\{C\_2}+\dots+\dfrac\{1}\{C\_n}
$$
...
$$
\left\{ \begin\{aligned} C&=\dfrac QU\ C&=\dfrac\{\varepsilon\_rS}\{4\pi kd}\ E&=\dfrac Ud \end\{aligned} \right.
$$
...
$$
Q=\dfrac\{\varepsilon\_r SU}\{4\pi kd}=\dfrac\{\varepsilon\_r SE}\{4\pi k}
$$

$$
U=\dfrac\{4\pi kdQ}\{\varepsilon\_r S}
$$

$$
E=\dfrac\{4\pi kQ}\{\varepsilon\_r S}
$$
...
- 对于求 $varphi$ 的，列出一个 $Ed\_\{AB}=U\_\{AB}=\varphi\_A-\varphi\_B$ 的 $d\_\{AB}$ 不变的式子，根据 $E$ 的变化和 $varphi\_A,\varphi\_B$ 中不变的一个，推导另一个的变化情况。
...
$$
U\_\{AB}q=W=\dfrac12mv\_B^2
$$

解得：

$$
v\_B=\sqrt\{\dfrac\{2U\_\{AB}q}m}
$$
...
!\[穿出]\(../屏幕截图 2025-01-26 182733.avif)\{align="right" width="35%"}
...
- 若向上移动下板：此时重力做功减小，$Uq$ 不变，在 $Q$ 点时\_动能小于零\_，这是不合理的，即无法到达 $Q$ 点或不穿出。
...
- 若向上移动上板：重力做功不变，$x$ 增大，在 $Q$ 点时\_动能小于零\_，这是不合理的，即无法到达 $Q$ 点或不穿出。
...
!\[交变电场]\(../屏幕截图 2025-01-26 193313.avif)
...
- 根据通过时间为 $t=L/v\_0$，列出两个方向的运动学方程求解。
...
$$
Uq=\dfrac12mv\_t^2-\dfrac12mv\_0^2
$$
...
$$
v\_0=\sqrt\{\dfrac\{2U\_0q}\{m}}
$$

根据偏转电场相关知识，电子离开偏转电场时偏转的距离为：

$$
x=\dfrac12at^2=\dfrac\{qU\cdot L^2\cdot m}\{2\cdot md\cdot 2U\_0q}=\dfrac\{UL^2}\{4U\_0d}
$$

与荷质比无关，而电子在偏转电场中的运动时间：

$$
t=\dfrac\{L}\{v\_0}=\sqrt\{\dfrac\{L^2m}\{2U\_0q}}
$$
