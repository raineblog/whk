...
![alt text](../验电器与静电计.avif#class="custom-img";align="right";float=30%"
...
![alt text](../fimage-5.avif#class="custom-img";float=40%"
...
![摩擦生电](../摩擦生电.avif#class="custom-img"
...
![感应起电](../Electroscope_showing_induction.avif#class="custom-img";align="right";float=50%"
...
![空球壳模型](../空球壳模型.svg#class="custom-img";float=100%"
...
![静电屏蔽](../静电屏蔽.svg#class="custom-img";float=100%"
...
![alt text](../fimage-6.avif#class="custom-img";float=80%"
...
![alt text](../fimage-4.avif#class="custom-img";float=40%"
