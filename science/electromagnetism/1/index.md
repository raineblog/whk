...
`<img src="../验电器与静电计.avif" align="right" width="30%">`{=html}
...
`<img src="../fimage-5.avif" width="40%" alt="alt text">`{=html}
...
`<img src="../摩擦生电.avif" alt="摩擦生电">`{=html}
...
`<img src="../Electroscope_showing_induction.avif" align="right" width="50%" alt="感应起电">`{=html}
...
`<img src="../空球壳模型.svg" width="100%" alt="空球壳模型">`{=html}
...
`<img src="../静电屏蔽.svg" width="100%" alt="静电屏蔽">`{=html}
...
`<img src="../fimage-6.avif" width="80%" alt="alt text">`{=html}
...
`<img src="../fimage-4.avif" width="40%" alt="alt text">`{=html}
