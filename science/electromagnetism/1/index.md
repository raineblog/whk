...
![alt text|right|w30%](/static/image/验电器与静电计.5271c6d3c7.avif)
...
![alt text|left|w50%](/static/image/image-7042d61.f35f57b10f.avif)
...
![alt text|w40%](/static/image/fimage-5.f3e787c97f.avif)
库仑证明两带电体间有相互作用力，且其定量关系可以方程表示。库仑定律的标量形式可以表示为：

$$
F\_\{库}=k\dfrac\{Q\_1Q\_2}\{r^2}
$$

理论上 $Q$ 应该带正负号，但是如果列标量方程，一般不带入正负号，表示库仑力的大小。

$$
\bm F=k\dfrac\{Q\_1Q\_2}\{r\_2}\hat\{\bm r}
$$
...
$$
F=k\dfrac\{q\_1q\_2}\{\varepsilon r^2}
$$
...
$$
q\_1:q\_2:q\_3=\ell\_1^2:\dfrac\{\ell\_1^2\ell\_2^2}\{\ell\_1^2+\ell\_2^2}:\ell\_2^2
$$

其中上面的式子可以化为

$$
\sqrt\{q\_1q\_3}=\sqrt\{q\_1q\_2}+\sqrt\{q\_2q\_3}
$$
...
![alt text|w80%](/static/image/image.1f768c9480.avif)
...
$$
F\_\{\text\{库}} = k \frac\{q\_1 q\_2}\{r^2} = 8.2 \times 10^\{-8}(\pu\{N})
$$

$$
F\_\{\text\{引}} = G \frac\{m\_1 m\_2}\{r^2} = 3.6 \times 10^\{-47}(\pu\{N})
$$
...
即 $q\_1+q\_2\to(q\_1+q\_2)/2+(q\_1+q\_2)/2$ 的公式表达。

注意到这是符合电荷守恒定律的。

### 感应起电

![感应起电|right|w50%](/static/image/Electroscope_showing_induction.7afd41d4eb.avif)
...
![静电屏蔽|w100%](/static/svg/静电屏蔽.7ff9b6e162.svg)
...
![alt text|w80%](/static/image/fimage-6.f98133e576.avif)
具体过程：
...
![alt text|w40%](/static/image/fimage-4.21487a2575.avif)
...
1. ::: \{#fn:noteesda}
   [https://www.esda.org/assets/Documents/Fundamentals-Part-1-SimplifiedChinese.pdf](https://www.esda.org/assets/Documents/Fundamentals-Part-1-SimplifiedChinese.pdf) [↩](#fnref:noteesda "Jump back to footnote 1 in the text")\{.footnote-backref}[↩](#fnref2:noteesda "Jump back to footnote 1 in the text")\{.footnote-backref}
   :::
   :::
