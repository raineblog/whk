...
![alt text](/static/image/image-18.5979756823.avif)
...
![alt text](/static/svg/Geomagnetisme.907510645a.svg)
...
![alt text](/static/image/image-7.b4fd9b6963.avif)
...
![alt text](/static/image/image-22.0705ee037d.avif)
...
![alt text](/static/image/image-9.f6cb0ef54a.avif)
...
![alt text](/static/image/image-30.9751449986.avif)
...
![alt text](/static/image/image-28.c94a900655.avif)
...
!\[alt text]\(../shapes at 25-07-23 19.13.09.svg#class="custom-img";float="70%")
...
![alt text](/static/image/image-12.58171eb142.avif)
...
![alt text](/static/image/image-34.b6cc81a39b.avif)
...
![alt text](/static/svg/20251016160917.ec666d915f.svg)
...
![alt text](/static/image/image-33.be2d84d0cd.avif)
![alt text](/static/image/image-35.3b5b952b29.avif)
...
![alt text](/static/image/20251017202756.0c0b303c0f.avif)
...
![alt text](/static/image/20251017203246.d7273ce347.avif)
![alt text](/static/image/20251017203332.717df527f9.avif)
容易发现，在左图中，进行的是一个匀速圆周运动，在右图中，进行的是一个匀速直线运动。我们将其合并起来，就会有两（三）种情况，需要讨论圆周运动的速度与直线运动的速度的大小关系，另外一种情况如图所示：

![alt text](/static/image/image-36.a7ff8a097b.avif)
## 电磁应用 \{#\_21}
...
![alt text](/static/image/image-11.983d91bac5.avif)
...
![alt text](/static/image/image-37.01a751aec3.avif)
...
![alt text](/static/image/image-13.70508a8033.avif)
容易知道，其螺距 $h$ 为：
...
![alt text](/static/image/image-14.61f6ddeb2e.avif)
也就是说：
...
![alt text](/static/image/image-15.3535a5ed89.avif)
![alt text](/static/image/image-38.8733e5dca2.avif)
...
![alt text](/static/image/image-16.c95346606e.avif)
那么，运动粒子所收到的洛伦兹力就会向着内方向倾斜，把粒子从强磁场区赶回弱磁场区，这样的装置称为磁瓶。

![alt text](/static/image/image-17.7f6460f0d9.avif)
在受控热核聚变的研究中，需要将高温的等离子体约束起来，最常用的就是环形磁约束结构，这样的环形磁场可以更好的约束粒子，不容易逃逸。

![alt text](/static/image/image-23.0857768da7.avif)
...
![alt text](/static/image/image-21.3856d74e80.avif)
...
![alt text](/static/image/image-19.f475717b65.avif)
...
![alt text](/static/image/image-20.c85fc7daef.avif)
...
![alt text](/static/image/image-29.f0c19fda77.avif)
