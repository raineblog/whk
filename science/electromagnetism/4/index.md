...
![alt text](/static/image/image-18.5979756823.avif){width="100%"}
...
![alt text](/static/svg/Geomagnetisme.907510645a.svg){align="right" width="50%"}
...
![alt text](/static/image/image-7.b4fd9b6963.avif){width="60%"}
...
![alt text](/static/image/image-8.2e47c6e22c.avif)
我们将在电磁感应中学到：
...
![alt text](/static/image/image-22.0705ee037d.avif){width="90%"}
...
- **洛伦兹力的方向**
  ...
  ***
  ...
  <img alt="alt text" src={image8} />\{width="100%"}
...
- **右手定则**
  ...
  ***
  ...
  <img alt="alt text" src={image10} />\{width="100%"}
...
- **弗莱明右手定则**
  ...
  ***
  ...
  <img alt="alt text" src={image11} />\{width="100%"}
...
设电荷 $q$ 的速度 $v$ 与磁感应强度 $B$ 之间的夹角为 $theta$。我们可以把 $B$ 分解为垂直于速度方向和沿速度方向的两个分量 $B\_\perp$ 和 $B\_\{//}$。

![alt text](/static/image/image-9.f6cb0ef54a.avif){width="50%"}
...
![alt text](/static/image/image-30.9751449986.avif){width="70%"}
...
![alt text](/static/image/image-28.c94a900655.avif){width="30%"}
...
![alt text](/static/image/image-12.58171eb142.avif){width="40%"}
...
![alt text](/static/image/image-34.b6cc81a39b.avif){width="70%"}
...
![](/static/svg/20251016160917.ec666d915f.svg){width="60%"}
...
![alt text](/static/image/image-33.be2d84d0cd.avif){width="90%"}
![alt text](/static/image/image-35.3b5b952b29.avif){width="90%"}
...
![alt text](/static/image/20251017202756.0c0b303c0f.avif){width="70%"}
...
![](/static/image/20251017203246.d7273ce347.avif){width="90%"}
![](/static/image/20251017203332.717df527f9.avif){width="90%"}
容易发现，在左图中，进行的是一个匀速圆周运动，在右图中，进行的是一个匀速直线运动。我们将其合并起来，就会有两（三）种情况，需要讨论圆周运动的速度与直线运动的速度的大小关系，另外一种情况如图所示：

![alt text](/static/image/image-36.a7ff8a097b.avif){width="60%"}
## 电磁应用 \{#\_21}
...
![alt text](/static/image/image-11.983d91bac5.avif){width="30%"}
...
![alt text](/static/image/image-37.01a751aec3.avif){width="40%"}
...
![alt text](/static/image/image-13.70508a8033.avif){width="60%"}
容易知道，其螺距 $h$ 为：
...
![alt text](/static/image/image-14.61f6ddeb2e.avif){width="60%"}
也就是说：
...
![alt text](/static/image/image-15.3535a5ed89.avif){width="50%"}
![alt text](/static/image/image-38.8733e5dca2.avif){width="80%"}
...
![alt text](/static/image/image-16.c95346606e.avif){width="80%"}
那么，运动粒子所收到的洛伦兹力就会向着内方向倾斜，把粒子从强磁场区赶回弱磁场区，这样的装置称为磁瓶。

![alt text](/static/image/image-17.7f6460f0d9.avif){width="40%"}
在受控热核聚变的研究中，需要将高温的等离子体约束起来，最常用的就是环形磁约束结构，这样的环形磁场可以更好的约束粒子，不容易逃逸。

![alt text](/static/image/image-23.0857768da7.avif){width="60%"}
...
![alt text](/static/image/image-21.3856d74e80.avif){width="60%"}
我们发现，当磁场和电流一定时，磁场力矩决定于线圈的面积和 $theta$，$theta=\pi/2$ 时，即线圈平面域磁感线平行时，$L$ 最大；$theta=0$ 时 $L=0$，也成为平衡位置。
...
![alt text](/static/image/image-19.f475717b65.avif){width="100%"}
...
![alt text](/static/image/image-20.c85fc7daef.avif){width="40%"}
...
![alt text](/static/image/image-29.f0c19fda77.avif){width="80%"}
