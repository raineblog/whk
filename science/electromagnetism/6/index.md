...
![alt text](../e-image-43.avif#class="custom-img";float="100%")
...
![alt text](../e-image-33.avif#class="custom-img";float="100%")

可以根据右手定则来判断线圈运动时，因导体棒运动时，垂直于磁感线方向的速度不断变化，所以感应电动势也在变化，感应电流同时发生变化。下面是一个经典教材中的配图：

![alt text](../e-image-39.avif#class="custom-img";float="100%")
...
![alt text](../e-image-32.avif#class="custom-img";float="85%")
...
![alt text](../e-image-35.avif#class="custom-img";align="right";float="40%")
...
![alt text](../e-image-38.avif#class="custom-img";float="90%")

在电工中常用的电流钩表（因为形状是可以开合的钩表，因此也被称为钳形电流表）就是运用的电流互感器（现在更多的使用霍尔原理，更加灵敏），其不向上面右图那样接入电路，而是直接将铁环包在导线上：

![alt text](../e-image-40.avif#class="custom-img";float="80%")

日字形变压器：对于这种形式的变压器，题目一般会给出磁通量在两条路径上的分摊百分比，根据比值计算即可。

![alt text](../e-image-34.avif#class="custom-img";float="60%")
...
![alt text](../e-image-36.avif#class="custom-img";float="100%")
...
![alt text](../e-image-53.avif#class="custom-img";float="70%")

![alt text](../e-image-54.avif#class="custom-img";float="70%")
...
![alt text](../Alternator_1.svg#class="custom-img";align="right";float="40%")
...
![alt text](../e-image-41.avif#class="custom-img";float="100%")
...
![alt text](../e-image-55.avif#class="custom-img";float="80%")

  
![alt text](../e-image-56.avif#class="custom-img";float="80%")
...
![alt text](../e-image-57.avif#class="custom-img";float="40%")
...
![alt text](../e-image-58.avif#class="custom-img";float="40%")
...
![alt text](../e-image-60.avif#class="custom-img";float="65%")
...
![alt text](../e-image-59.avif#class="custom-img";float="40%")
...
![alt text](../e-image-45.avif#class="custom-img";float="100%")
...
![alt text](../e-image-46.avif#class="custom-img";float="70%")
...
![alt text](../e-image-62.avif#class="custom-img";float="100%")
...
![alt text](../e-image-61.avif#class="custom-img";float="100%")
...
![alt text](../e-image-47.avif#class="custom-img";float="80%")
...
![alt text](../e-image-48.avif#class="custom-img";float="40%")
...
![alt text](../e-image-49.avif#class="custom-img";float="90%")
...
![alt text](../e-image-50.avif#class="custom-img";float="60%")
...
![alt text](../e-image-51.avif#class="custom-img";align="right";float="30%")
...
![alt text](../e-image-52.avif#class="custom-img";float="100%")
