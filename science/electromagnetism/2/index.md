...
**电通量**：穿过电场 E 中某一截面 ΔS 的电通量 Δφe​ 被定义为：

Δφe​=E⋅ΔS=EΔScosθ

式中 θ 为截面 ΔS 的法线与电场线间的夹角，它实际上可理解为穿过 ΔS 的电场线的条数。

φe​=ΔS∑​Ei​ΔSi​cosθ

当电场线穿过一个有限大小曲面 S 时，其电通量等于其上无限多个小面元上的电通量的代数和： 其中 E 为闭合面 S 上每一个面元 ΔS 处的电场强度，这个 E 是由所有形成静电场的电荷（包括 S 面内外的电荷）在该面元 ΔS 处激发产生的电场强度。而等号右边的电荷代数和，仅指 S 面内的电荷。
...
如以离场源电荷无穷远处（即 rb​→∞）电荷的电势能为零，则电荷 q 在离场源电荷 r(ra​=r) 处的电势能就是：
