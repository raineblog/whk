...
\$f(x)=\displaystyle\sum\_{n=0}^{+\infty}a_nx^n\$，原式变为 \$x^{-1}(a\_{n+1}x^)+a_nx^n=(2x)^n\$，再求和有

\$\$\displaystyle\sum\_{n=0}^{+\infty}x^x}(a\_{n+1^{n+1})+\sum\_{n=0}^(a_nx^n)=\sum\_{n=0}^\$\$}(2x)\^n=\frac{1}{1-2x}\implies (\frac{1}{x}+1)f(x)=\frac{1}{1-2x
...
\$\$\implies f(x)=\frac{1-\left{1+\displaystyle\sum\_{k=1}\^{+\infty}\left\[-2\begin{pmatrix}2k-2\\ k-1\end{pmatrix}\right\]x^k\right}}{2x}=\sum\_{k=0}^\$\$}\frac{\begin{pmatrix}2k\k\end{pmatrix}x\^k}{k+1}\implies\red{\boxed{C_n=\frac{\begin{pmatrix}2n\n\end{pmatrix}}{n+1}}
