...
- 若 \$n=2k-1(k \in \mathbb{N}\^\*)\$，则 \$f(x)\$ 的图像是以 \$(a_k, f(a_k))\$ 为顶点的"V 字形"图像。
  ...
  - 当且仅当 \$x=a_k\$ 时，\$\[f(x)\]*{\min} = \|(a_1 + a_2 + \cdots + a*)\|\$；}) - (a\_{k+1} + a\_{k+2} + \cdots + a\_{2k-1
...
- 若 \$n=2k(k \in \mathbb{N}\^\*)\$，则 \$f(x)\$ 的图像是以点 \$A(a_k, f(a_k))\$, \$B(a\_{k+1}, f(a\_{k+1}))\$ 为折点的倒梯形。
  ...
  - 当且仅当 \$x \in \[a_k, a\_{k+1}\]\$ 时，\$\[f(x)\]*{\min} = \|(a_1+a_2+\cdots+a_k) - (a*)\|\$；}+a\_{k+2}+\cdots+a\_{2k
...
\$\$ x_1^{\lambda_1}x_2^\le\lambda_1x_1+\lambda_2x_2+\dots+\lambda_nx_n \$\$}\dots x_n\^{\lambda_n
