...
\$\$ \begin{aligned} (x+y)^n&=\sum\_{k=0}^n{n\choose k}x^ky^\\ (x+1)^n&=\sum\_{k=0}^n{n\choose k}x\^k \end{aligned} \$\$
...
\$\$ \begin{aligned} a^n-b^n&=(a-b)(a^{n-1}+a^)\\ a}b+\dots+b\^{n-1^n+b^n&=(a+b)(a^{n-1}-a^)&n=2k+1,k\in\mathbb Z \end{aligned} \$\$}b+\dots+b\^{n-1
...
\$\$ \begin{array}{lllll} &2^{1}\\\\=2&2^\\\\=4&2^{3}\\\\=8&2^\\\\=16\\ 2^{5}\\\\=32&2^\\\\=64&2^{7}\\\\=128&2^\\\\=512\\ 2}\\\\=256&2\^{9^{10}=1024&2^=2048&2^{12}=4096&2^=16384\\ 2}=8192&2\^{14^{15}=32768&2^=65536 \end{array} \$\$

\$\$ \begin{array}{llllll} 3^{2}=9&3^=27&3^{4}=81&3^=243&3^{6}=729&3^=2187\\ 5^{2}=25&5^=125&5^{4}=625&5^=3125&5^{6}=15625&5^=78125 \end{array} \$\$
...
\$\$ a^n-b^n=(a-b)(a^{n-1}+a^) \$\$}b+\dots+b\^{n-1

\$\$ a^n+b^n=(a+b)(a^{n-1}-a^),n\equiv1\pmod2 \$\$}b+\dots\pm b\^{n-1
...
- 方程有两个根在 \$(l, r)\$ 之间：
  ...
  \$\$ \Delta \> 0, l \< -\frac{b}{2a} \< r, f(l)f® \> 0 \$\$

- 方程有两个根在 \$\[l, r\]\$ 之间：

  \$\$ \Delta \> 0, l \< -\frac{b}{2a} \< r, a \cdot f(l) \ge 0, a \cdot f® \ge 0 \$\$
...
- 方程有两个根，一个在 \$\[l, r\]\$ 之间：
  ...
  \$\$ \Delta \> 0, f® = 0, -\frac{b}{2a} \< \frac{l+r}{2} \$\$
...
\$\$ f(x)=f(a)+\dfrac{f\'(a)}{1!}(x-a)+\dfrac{f\'\'(a)}{2!}(x-a)^2+\dots+\dfrac{f^(x-a)\^n+R_n(x) \$\$}(a)}{n!
