...
- 当 $a>0$ 时：设 $g(x)$ 与 $h(x)$ 相切于点 $(x_0,e^{x_0})$，此时直线
  $h(x)$ 的斜率 $a_0$ 就应当等于曲线在该点的切线斜率
...
`<img src="../desmos-graph (2).svg" alt="alt text">`{=html}

`<img src="../desmos-graph.svg" alt="alt text">`{=html}
