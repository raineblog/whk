...
- 当 \$r\ge0\$，或 \$r\le-1\$ 时，有
  ...
  \$\$ \frac{a_1^{r+1}}{b_1^+\frac{a_2}^{r+1}}{b_2^+\cdots+\frac{a_n}^{r+1}}{b_n^\ge\frac{(a_1+a_2+\cdots+a_n)}^{r+1}}{(b_1+b_2+\cdots+b_n)^。 \$\$}

- 当 \$-1\<r\<0\$ 时，有

  \$\$ \frac{a_1^{r+1}}{b_1^+\frac{a_2}^{r+1}}{b_2^+\cdots+\frac{a_n}^{r+1}}{b_n^\le\frac{(a_1+a_2+\cdots+a_n)}^{r+1}}{(b_1+b_2+\cdots+b_n)^。 \$\$}

### 杨格不等式 {#_10}

若 \$a,b\>0，p\>1，\dfrac{1}{p}+\dfrac{1}{q}=1\$，则有

\$\$ ab\le\dfrac{1}{p}a^{p}+\dfrac{1}{q}b^。 \$\$
