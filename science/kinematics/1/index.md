...
- *Θ*：热力学温度（Thermodynamic Temperature）。
- *N*：物质的量（Amount of Substance）。

| 物理量         | 符号     | 国际标准单位           | 常用单位                           | 量纲                |
| -------------- | -------- | ---------------------- | ---------------------------------- | ------------------- |
| **一、力学**   |          |                        |                                    |                     |
| 时间           | *t*      | 秒（s）                | 分钟（min），小时（h）             | *T*                 |
| 长度           | *x*      | 米（m）                |                                    | *L*                 |
| 质量           | *m*      | 千克（kg）             | 吨（t）                            | *M*                 |
| 速度           | *v*      | 米/秒（m/s）           | 千米/小时（km/h）                  | *L\*\*T*−1          |
| 加速度         | *a*      | 米/秒²（m/s2）         |                                    | *L\*\*T*−2          |
| 力             | *F*      | 牛顿（N）              |                                    | *M**L**T*−2         |
| 密度           | *ρ*      | 千克/立方米（kg/m3）   | 克/立方厘米（g/cm3）               | *M\*\*L*−3          |
| 压强           | *P*      | 帕斯卡（Pa）           | 标准大气压（atm） 毫米汞柱（mmHg） | *M\*\*L*−1*T*−2     |
| 功             | *W*      | 焦耳（J）              | 千瓦时（kW ⋅ h） 电子伏特（eV）    | *M\*\*L*2*T*−2      |
| 能量           | *E*      | 焦耳（J）              | 千瓦时（kW ⋅ h） 电子伏特（eV）    | *M\*\*L*2*T*−2      |
| 功率           | *P*      | 瓦特（W）              | 马力（hp）                         | *M\*\*L*2*T*−3      |
| 动量           | *p*      | 千克·米/秒（kg ⋅ m/s） |                                    | *M**L**T*−1         |
| 冲量           | *I*      | 牛顿·秒（N ⋅ s）       |                                    | *M**L**T*−1         |
| 角速度         | *ω*      | 弧度/秒（rad/s）       |                                    | *T*−1               |
| 周期           | *T*      | 秒（s）                |                                    | *T*                 |
| 频率           | *f*      | 赫兹（Hz）             |                                    | *T*−1               |
| 万有引力常量   | *G*      | N ⋅ m2/kg2             |                                    | *M*−1*L*3*T*−2      |
| 波长           | *λ*      | 米（m）                | 埃（Å）                            | *L*                 |
| **二、电磁学** |          |                        |                                    |                     |
| 电荷量         | *q*      | 库仑（C）              |                                    | *I\*\*T*            |
| 电流           | *I*      | 安培（A）              |                                    | *I*                 |
| 电压           | *U*      | 伏特（V）              |                                    | *M\*\*L*2*T*−3*I*−1 |
| 电动势         | *E*      | 伏特（V）              |                                    | *M\*\*L*2*T*−3*I*−1 |
| 电场强度       | *E*      | N/C 或 V/m             |                                    | *M**L**T*−3*I*−1    |
| 电阻           | *R*      | 欧姆（*Ω*）            |                                    | *M\*\*L*2*T*−3*I*−2 |
| 电阻率         | *ρ*      | 欧姆·米（*Ω* ⋅ m）     |                                    | *M\*\*L*3*T*−3*I*−2 |
| 电功           | *W*      | 焦耳（J）              | 千瓦时（kW ⋅ h）                   | *M\*\*L*2*T*−2      |
| 电功率         | *P*      | 瓦特（W）              |                                    | *M\*\*L*2*T*−3      |
| 电容           | *C*      | 法拉（F）              |                                    | *M*−1*L*−2*T*4*I*2  |
| 磁感应强度     | *B*      | 特斯拉（T）            | 高斯（G）                          | *M\*\*T*−2*I*−1     |
| 磁通量         | *Φ*      | 韦伯（Wb）             |                                    | *M\*\*L*2*T*−2*I*−1 |
| 静电力常量     | *k*      | N ⋅ m2/C2              |                                    | *M\*\*L*3*T*−4*I*−2 |
| **三、其他**   |          |                        |                                    |                     |
| 热力学温度     | *T*      | 开尔文（K）            | 摄氏度（∘C）                       | *Θ*                 |
| 热量           | *Q*      | 焦耳（J）              | 卡路里（cal）                      | *M\*\*L*2*T*−2      |
| 内能           | *U*      | 焦耳（J）              |                                    | *M\*\*L*2*T*−2      |
| 比热容         | *c*      | J/(kg ⋅ K)             |                                    | *L*2*T*−2*Θ*−1      |
| 物质的量       | *n*      | 摩尔（mol）            |                                    | *N*                 |
| 摩尔质量       | *M*      | 千克/摩尔（kg/mol）    | 克/摩尔（g/mol）                   | *M\*\*N*−1          |
| 阿伏伽德罗常量 | *N\*\*A* | 每摩尔（mol−1）        |                                    | *N*−1               |
| 普朗克常量     | *h*      | 焦耳·秒（J ⋅ s）       |                                    | *M\*\*L*2*T*−1      |
| 光子能量       | *E*      | 焦耳（J）              | 电子伏特（eV）                     | *M\*\*L*2*T*−2      |
| 逸出功         | *W*0     | 焦耳（J）              | 电子伏特（eV）                     | *M\*\*L*2*T*−2      |
