...
\$\$ y=\dfrac{H}{½L}x=\dfrac{1}{2}\tan\theta x \$\$
...
根据对称性，抛出时速度 \$v_0=30\mathrm{m/s}\$，夹角 \$\theta=\cot(v_y/v_x)=\cot(¾)=37\^\circ\$。

落地飞行时间，即 \$y=0\$ 时的 \$t\$，则 \$t_1=0\mathrm{s},\\t_2=3.6\mathrm{s}\$，其中 \$0\$ 为抛出时（舍）。

射高，即 \$v_y=0\$ 时的 \$y\$，即 \$y\|*{t=1.8\mathrm{s}}=16.2\mathrm{m}\$；射程，即 \$x\|*\$。}}=86.4\mathrm{m
