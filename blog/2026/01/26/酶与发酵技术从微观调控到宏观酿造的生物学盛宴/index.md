...
- **机制**：抑制剂与底物竞争结合活性中心。
- **动力学特征**：(V\_{max})（最大反应速率）**不变**，但 (K_m)（米氏常数）**增大**。这意味着由于抑制剂的存在，酶对底物的亲和力在表观上降低了。
...
- **动力学特征**：(V\_{max}) **减小**，(K_m) **不变**。由于酶的有效数量减少，无论增加多少底物，都无法达到原先的最大反应速度。一些重金属离子（如 (\\ce{Hg^2+})）常表现出此类特性。
...
- **动力学特征**：(V\_{max}) 与 (K_m) **同时减小**。这常令初学者困惑，但实际上是因为 ES 复合物被移除，促进了底物与酶的结合，表观上亲和力反而增加了。
