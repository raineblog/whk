...
1. **AI 初创公司（AI Startups）**：规模相对精简，专注技术创新。
...
| 模型              | AA-LCR 长上下文推理 | GPQA Diamond 科学推理 | CritPt 物理推理 | AIME 2025 美国数学邀请赛 |
| ----------------- | ------------------- | --------------------- | --------------- | ------------------------ |
| **Kimi K2.5**     | (66%)               | (88%)                 | (3%)            | -                        |
| **Qwen3 Max**     | (66%)               | (86%)                 | (2%)            | -                        |
...
1. **提供背景（Context）**：给 AI 足够的信息，避免它“盲目猜测”。
1. **任务拆解（Step-by-Step）**：让 AI 分步思考，这能显著提升其逻辑推理能力。
1. **明确限制（Constraints）**：规定输出的格式、语气或字数。
