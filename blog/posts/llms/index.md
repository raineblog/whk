...
# 生成式人工智能在学习中的应用与实例探究报告 \{style="font-family:var(--fontkit-cjk-kai);color:#000;border-bottom:none;margin-bottom:2rem;font-size:2.2rem;line-height:1.4"}
...
![The Decline of DeepSeek's Dominance](/static/image/llm-image-1.8267a04513.avif)
中国活跃的 AI 参与者大致可分为两类：
...
![Token Usage By Source Type](/static/image/llm-image.65fbcbf181.avif)
